...
export default function VisualDrillsClient() {
  ...
  const drills = [
    ...
    { id: 11, name: 'Visual Search', folderName: 'visual-search', category: 'Visual Recognition', subcategory: 'visual-recognition', difficulty: 'Advanced', duration: '60s', description: 'Find the letter C among 160 O distractors in a 16Ã—10 grid. +1 per find, -1 wrong.', enabled: true },
    { id: 12, name: 'Entropic Grid', folderName: 'entropic-grid', category: 'Visual Recognition', subcategory: 'visual-recognition', difficulty: 'Advanced', duration: '90s', description: 'Find the 2-char target in a 10Ã—10 grid. Cells randomly corrupt every 800ms. Stamina system with 90s challenge.', enabled: true },
    { id: 13, name: 'Rhythm Anomaly', folderName: 'rhythm-anomaly', category: 'Visual Recognition', subcategory: 'visual-recognition', difficulty: 'Advanced', duration: '90s', description: 'Find the faster-pulsing cell (1.4s) among steady cells (2s) in a 6Ã—6 grid. Stamina system.', enabled: true },
