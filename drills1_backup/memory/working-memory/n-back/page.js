...
export const metadata = {
  title: "3 - Memory Training & Focus Drill | SkillDrills",
  description: "Train working memory with classic N-Back task at 3-back level. Play free in your browser with no downloads or registration required.",
  keywords: [
    "n back",
    "n back training",
    "n back game",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/memory/n-back',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "3 - Memory Training & Focus Drill | SkillDrills",
    description: "Train working memory with classic N-Back task at 3-back level. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/memory/n-back',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "3 - Memory Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function NBackPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in N Back?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the N Back drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the N Back drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in N Back?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the N Back drill completely free?</h4>
