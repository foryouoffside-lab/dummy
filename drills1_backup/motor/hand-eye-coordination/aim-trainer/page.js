...
export const metadata = {
  ...
  description: "Free aim trainer online. Play free in your browser with no downloads or registration required.",
  keywords: [
    "aim trainer",
    "aim trainer training",
    "aim trainer game",
    "aim trainer test",
    "aim trainer online",
    "free aim trainer",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/motor/aim-trainer',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Free Aim Trainer Online - Mouse Accuracy Drill | SkillDrills",
    description: "Free aim trainer online. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/motor/aim-trainer',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Free Aim Trainer Online - Mouse Accuracy Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function AimTrainerPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Aim Trainer drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Aim Trainer?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Aim Trainer drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Aim Trainer drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Aim Trainer?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Aim Trainer drill completely free?</h4>
