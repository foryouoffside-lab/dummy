...
export const metadata = {
  title: "Target Switching Aim Trainer - Multi-Target Practice | SkillDrills",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Target Switching Aim Trainer - Multi-Target Practice | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function TargetAcquisitionPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Target Acquisition?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Target Acquisition drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Target Acquisition drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Target Acquisition?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Target Acquisition drill completely free?</h4>
