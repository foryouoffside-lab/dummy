...
export const metadata = {
  title: "Wide Field - Visual Training & Focus Drill | SkillDrills",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/visual/wide-field',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Wide Field - Visual Training & Focus Drill | SkillDrills",
    description: "Train peripheral vision with characters flashing 400ms in 4 corners. Fixate center, recall 1-3 characters in order. Perfect recall 10pts/char. No sign-up.",
    url: 'https://skilldrills.online/drills/visual/wide-field',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Wide Field - Visual Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function WideFieldPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Wide Field drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Wide Field?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Wide Field drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Wide Field drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Wide Field?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Wide Field drill completely free?</h4>
