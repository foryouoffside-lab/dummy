...
export const metadata = {
  ...
  keywords: [
    "finger sequencing",
    "finger sequencing training",
    "finger sequencing game",
    "finger sequencing test",
    "finger sequencing online",
    "free finger sequencing",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/motor/finger-sequencing',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Finger Speed Test - Free Finger Sequencing Drill | SkillDrills",
    description: "Free finger speed test online. Click 3 nodes from largest to smallest within 2 seconds — the best finger sequencing and motor speed drill. 3-life system. No sign-up required.",
    url: 'https://skilldrills.online/drills/motor/finger-sequencing',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Finger Speed Test - Free Finger Sequencing Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function FingerSequencingPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Finger Sequencing drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Finger Sequencing?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Finger Sequencing drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Finger Sequencing drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Finger Sequencing?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Finger Sequencing drill completely free?</h4>
