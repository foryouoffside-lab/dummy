...
export const metadata = {
  ...
  keywords: [
    "symbol matching",
    "symbol matching training",
    "symbol matching game",
    "symbol matching test",
    "symbol matching online",
    "free symbol matching",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/cognitive/symbol-matching',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Symbol Matching - Flexibility Drill | SkillDrills",
    description: "Train cognitive flexibility by matching Greek symbols to numbers with keys that change after every answer. 75-second challenge. No sign-up.",
    url: 'https://skilldrills.online/drills/cognitive/symbol-matching',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Symbol Matching - Flexibility Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function SymbolMatchingPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Symbol Matching?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Symbol Matching drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Symbol Matching drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Symbol Matching?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Symbol Matching drill completely free?</h4>
