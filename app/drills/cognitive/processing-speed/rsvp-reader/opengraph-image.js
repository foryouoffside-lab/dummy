...
export const alt = 'RSVP Speed Reader — free browser Rapid Serial Visual Presentation cognitive reading drill';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            Train Rapid Serial Visual Presentation speed, ORP focal decoding, and lexical throughput.
          </div>
        </div>

        {/* Stat strip */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          {['45-SECOND DRILL', 'RSVP ORP PARADIGM', '15 DIFFICULTY LEVELS', 'FREE — NO SIGN-UP'].map((label) => (
            <div
              key={label}
              style={{
                display: 'flex',
