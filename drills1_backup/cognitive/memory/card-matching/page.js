...
export const metadata = {
  title: "Card Matching - Cognitive Training & Focus Drill | SkillDrills",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/cognitive/card-matching',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Card Matching - Cognitive Training & Focus Drill | SkillDrills",
    description: "Train visual memory with 15+ icons on expanding grids from 12 to 32+ cards. Combo streaks, no penalties, 60-second challenge. No sign-up.",
    url: 'https://skilldrills.online/drills/cognitive/card-matching',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Card Matching - Cognitive Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function CardMatchingPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Card Matching drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Card Matching?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Card Matching drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Card Matching drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Card Matching?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Card Matching drill completely free?</h4>
