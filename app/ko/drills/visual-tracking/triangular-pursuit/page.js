...
const guide = {
  ...
  intro: [
    ...
    "본 '삼각형 안구 추적(Triangular Pursuit)' 드릴은 이러한 기하학적 안구 민첩성을 웹 환경에서 체계적으로 단련하도록 설계되었습니다. 정삼각형 궤도를 회전하는 표적을 추적하며 직선 등속 추종과 3개 코너에서의 급감속·재가속 제어력을 동시에 극대화할 수 있습니다. 'Hide Line(궤적 숨김)' 모드를 켜면 안내선을 완전히 제거한 순수 감각운동 추종 능력을 테스트할 수 있으며, 'Random Speed'를 통해 기계적 타이밍 암기를 배제한 실전 적응 훈련이 가능합니다. 고주사율 디스플레이 환경(Woods et al., 2015)에서 코너 착지 오차 0px를 목표로 최고 수준의 시각 정밀도를 구축하십시오."
  ],
  benchmarks: {
