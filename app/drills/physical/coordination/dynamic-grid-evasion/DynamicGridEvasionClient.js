              ...
              <div className="p-8">
                ...
                <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FAQItem 
                      q="What is a Grid Evasion Game?" 
                      a="A Grid Evasion Game is a spatial awareness and reflex training drill where players must navigate a dynamic grid, identifying safe zones and moving their cursor away from incoming threats before they detonate." 
                    />
                    <FAQItem 
                      q="How does this improve coordination?" 
                      a="By forcing you to process peripheral visual information rapidly and execute a precise motor movement to a safe location, it heavily strengthens visual-motor integration and hand-eye coordination." 
                    />
                    <FAQItem 
                      q="Does this improve FPS gaming?" 
                      a="Yes. Spatial awareness games train tactical movement and cursor agility under pressure—critical skills for dodging utility and executing engagements in tactical shooters." 
                    />
                    <FAQItem 
                      q="Is this good for Valorant?" 
                      a="Absolutely. The rapid threat identification and repositioning directly translates to dodging flashes, grenades, and ultimate abilities while maintaining crosshair control." 
                    />
                    <FAQItem 
                      q="Is this useful for CS2?" 
                      a="Yes, peripheral scanning and mouse agility are fundamental for quickly checking multiple angles and repositioning your crosshair across a site in CS2." 
                    />
                    <FAQItem 
                      q="Does it improve hand-eye coordination?" 
                      a="Yes, because you must physically move your mouse to match the safe coordinate you visually identified, syncing your visual cortex with your motor cortex." 
                    />
                    <FAQItem 
                      q="Does the game get harder over time?" 
                      a="Yes. As you score points, the warning times drop from 1.40s down to a blistering 0.60s, and the number of simultaneous threats increases up to 7 cells." 
                    />
                    <FAQItem 
                      q="Are there penalties for explosions?" 
                      a="Yes, being caught in an explosion triggers a 4-second deduction to your survival clock, forcing you to maintain high evasion accuracy to stay alive." 
                    />
                    <FAQItem 
                      q="How long should I practice spatial awareness daily?" 
                      a="For optimal cognitive adaptation and reflex training, practicing this drill for 5 to 10 minutes a day is more effective than long, exhausting sessions." 
                    />
                    <FAQItem 
                      q="Is this free?" 
                      a="Yes! The SkillDrills Grid Evasion Game is entirely free, open-source, and runs purely in your web browser with zero downloads required." 
                    />
                  </div>
                </div>
              </div>
