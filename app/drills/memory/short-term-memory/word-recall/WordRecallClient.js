...
export default function WordRecallClient() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      setBestWords(saved.bestWords || 3);
    }
  }, []);
    ...
    <div className="min-h-screen bg-[#050508] text-white flex flex-col font-sans select-none">
      ...
      <header className="border-b border-white/5 bg-[#080811]/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2 text-xs text-slate-400">
            ...
            <span>/</span>
            <span className="text-pink-400 font-medium">Word Recall</span>
          </div>
          <button
            onClick={() => {
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 py-6 flex flex-col gap-6">
        ...
        <div className="text-center">
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight bg-gradient-to-r from-white via-slate-200 to-pink-400 bg-clip-text text-transparent">
            WORD RECALL
          </h1>
        ...
        >
          ...
          {gameState === 'countdown' && (
            <DrillCountdown value={countdownValue} subtitle="GET READY" accent="#ec4899" />
          )}
