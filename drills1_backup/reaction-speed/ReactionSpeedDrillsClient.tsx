    ...
    <div className="min-h-screen bg-[#080d1a] text-slate-100 font-sans selection:bg-amber-500/30">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-slate-950/80 border border-slate-800 rounded-2xl p-8 mt-12 relative overflow-hidden backdrop-blur-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs text-slate-400 font-sans">
            <div>
              <h4 className="font-bold text-slate-200 mb-2 font-mono uppercase text-xs tracking-wider">What is a healthy average reaction time?</h4>
              <p className="leading-relaxed">The average human visual reaction time is approximately 250 milliseconds. Dedicated reflex training can help competitive gamers and athletes achieve times under 200 milliseconds.</p>
            </div>
            <div>
              <h4 className="font-bold text-slate-200 mb-2 font-mono uppercase text-xs tracking-wider">Can reaction speed be permanently improved?</h4>
              <p className="leading-relaxed">Yes. Regular reflex training exercises and saccadic gallery drills optimize sensory processing and motor execution paths, lowering response latency.</p>
            </div>
            <div>
              <h4 className="font-bold text-slate-200 mb-2 font-mono uppercase text-xs tracking-wider">Does reaction training translate to competitive shooters?</h4>
              <p className="leading-relaxed">Absolutely. Lowering your click latency by even 20-30 milliseconds gives you a major advantage in tactical shooter duels where first-shot precision is vital.</p>
            </div>
          </div>
        </div>
