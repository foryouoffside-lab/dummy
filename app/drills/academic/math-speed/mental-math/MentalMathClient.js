    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading mental math drill...</p>
        </div>
      </div>
    );
  }
    ...
    <div className={`min-h-screen select-none ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "Mental Math Speed Drill",
            "url": "https://skilldrills.online/drills/academic/math-speed/mental-math",
            "description": "Speed math drill with 3 difficulty levels (Basic 0.5pt, Pro 1pt, Elite 1.5pt). Practice addition, subtraction, and multiplication in a 60-second timed race with lives system and combo bonuses. Keyboard shortcuts 1-4 for rapid answering.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className={`text-sm sm:text-base ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                Choose the correct answer • 60-second challenge • 3 difficulty levels
              </p>
            </div>
          </div>
        ...
        <section className="sr-only" aria-label="Drill description for search engines">
          <h2>Mental Math Speed Drill - Arithmetic Brain Training</h2>
          <p>
            Sharpen your mental arithmetic with this timed math challenge. 
            Choose from 3 difficulty levels: Basic (0.5 points), Pro (1 point), and Elite (1.5 points).
            Practice addition, subtraction, and multiplication with 4-option multiple choice.
            Features a 3-life protection system, combo streaks every 3 correct answers, 
              ...
              <div className={`absolute inset-0 flex items-center justify-center backdrop-blur-sm rounded-xl z-40 ${isBoxDarkMode ? 'bg-gray-900/95' : 'bg-white/95'}`}>
                <div className={`rounded-2xl p-6 sm:p-8 text-center max-w-md mx-4 shadow-xl border ${isBoxDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                  ...
                  <button 
                    ...
                    aria-label="Start mental math drill"
                  >
                    Start Drill
                  </button>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Correct: <span className="font-semibold text-green-500">+{getPointsForCorrect()}pt</span> ({difficulty} mode)</p>
                    </div>
                    <div className="flex items-start gap-2">
