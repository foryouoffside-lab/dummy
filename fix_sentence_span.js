const fs = require('fs');
const file = 'C:/Users/sangmesh/Desktop/global-drill-system-nextjs - Copy/app/drills/memory/working-memory/sentence-span/SentenceSpanClient.js';
...
const startIdx = lines.findIndex(l => l === startStr || l === startStr + '\r');
...
if (startIdx !== -1 && endFooterIdx !== -1) {
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                <p className="text-sm text-gray-400 leading-relaxed mb-6">
                  This free, self-paced Sentence Span drill trains verbal working memory capacity. You are shown a sequence of sentences to process. Once all sentences have appeared, you must input the core nouns from each sentence. As you successfully input the correct nouns, the sequences get longer, actively pushing the limits of your reading span and free recall processing without the stress of a ticking clock.
                </p>
                ...
                <div className="mb-6 p-5 rounded-xl border border-gray-800 bg-black/40">
                  ...
                  <ul className="space-y-3 text-sm text-gray-400">
                    <li><strong className="text-green-400">Correct Noun:</strong> +3 PTS | Per Match</li>
                    <li><strong className="text-cyan-400">Perfect Round:</strong> Level Up | Adds 1 Sentence</li>
                    <li><strong className="text-red-400">Error Made:</strong> -3 PTS | Per Miss/Extra</li>
                    <li><strong className="text-orange-400">Errors Made:</strong> Level Down | Subtracts 1 Sentence</li>
                  </ul>
                </div>
              </div>
              ...
              <div>
                <div className="p-5 rounded-xl border border-gray-800 bg-black/40 mb-6">
                  ...
                  <ol className="space-y-3 list-decimal pl-5 text-sm text-gray-400">
                    <li><strong className="text-white">Read:</strong> Read each sentence carefully. A key noun will be highlighted or implied.</li>
                    <li><strong className="text-white">Memorize:</strong> Keep track of all the nouns from the sentences in the sequence.</li>
                    <li><strong className="text-white">Recall:</strong> Type all the nouns you memorized, separated by spaces.</li>
                  </ol>
                </div>
                ...
                <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-1">Students improving reading comprehension, professionals analyzing long documents, and anyone wanting to boost their verbal working memory capacity.</p>
                    </div>
                    <div>
                      <h4 className="text-sm font-bold text-gray-200">What skills are improved?</h4>
                      <p className="text-xs text-gray-400 mt-1">Verbal working memory, reading span, comprehension retention, and multi-tasking cognitive control.</p>
                    </div>
                  </div>
                </div>
              </div>
  ...
  return (
    ...
    console.log('Fixed SentenceSpanClient.js successfully.');
} else {
