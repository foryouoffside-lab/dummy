      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 py-6 flex flex-col gap-6">
        ...
        {!isFullscreen && (
          <div className="flex flex-col gap-1">
            <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-white">Digit Span Memory Test</h1>
          </div>
        )}
        ...
        {!isFullscreen && (
          <div className="grid grid-cols-4 gap-2 w-full -mb-2">
            {[
              ...
              { label: "Span", val: `${digitCount} Digits`, color: "text-indigo-400" },
        ...
        {!isFullscreen && (
          <p className="text-xs text-slate-400 leading-relaxed -mt-2">
            Memorize the flashing sequence of numbers, then enter the exact digits in order.
          </p>
        )}
