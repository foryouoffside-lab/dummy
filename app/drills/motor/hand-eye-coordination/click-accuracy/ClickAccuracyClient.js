    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: 'Free Click Accuracy Elite Drill | SkillDrills',
          text: 'Train mouse precision with a teleporting target that shrinks with streak. Free!',
          url: 'https://skilldrills.online/drills/motor/hand-eye-coordination/click-accuracy'
        });
      } catch (e) {}
    } else {
      navigator.clipboard.writeText('https://skilldrills.online/drills/motor/hand-eye-coordination/click-accuracy');
      alert('Link copied!');
    }
  };
  ...
  return (
    <div className={`min-h-screen select-none ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "Click Accuracy Elite - Precision Mouse Training & Reaction Time Practice",
            "url": "https://skilldrills.online/drills/motor/hand-eye-coordination/click-accuracy",
            "description": "Free precision mouse training with a single teleporting target. Target shrinks from 12px to 7px as streak increases. Teleports every 1.5 seconds automatically. 3-life protection system with reaction time tracking. 60-second timed challenge with streak-based color progression.",
            "applicationCategory": "GameApplication",
            "operatingSystem": "All",
            "offers": { "@type": "Offer", "price": "0", "priceCurrency": "USD", "availability": "https://schema.org/OnlineOnly" },
            "author": { "@type": "Organization", "name": "SkillDrills", "url": "https://skilldrills.online" },
            "publisher": { "@type": "Organization", "name": "SkillDrills" },
            "educationalUse": ["Mouse Precision Training", "Click Accuracy Practice", "Reaction Time Development", "Hand-Eye Coordination", "FPS Gaming Training"],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={`text-sm sm:text-base ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                  Free mouse precision drill • Teleporting target • Shrinks with streak • 60s
                </p>
              </div>
            </div>
        ...
        {!isFullscreen && (
          <section className="mt-8" aria-label="About this click accuracy drill">
            <div className={`rounded-xl border overflow-hidden ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
              <div className={`px-4 py-3 border-b ${isDarkMode ? 'border-gray-700 bg-gray-800/50' : 'border-gray-200 bg-gray-50'}`}>
                <div className="flex items-center gap-2">
                  <GraduationCap className={`w-5 h-5 ${isDarkMode ? 'text-purple-400' : 'text-purple-600'}`} aria-hidden="true" />
                  <h2 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>About This Free Click Accuracy Elite</h2>
                </div>
              </div>
              <div className="p-5">
                <p className={`text-sm leading-relaxed mb-5 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  This free click accuracy elite drill trains precision mouse control with a single teleporting target that demands speed and accuracy. The target automatically teleports to a new random position every 1.5 seconds and progressively shrinks from 12px down to 7px as your hit streak increases. Each click provides instant reaction time feedback in milliseconds with streak-based visual progression from white to green at 5+ streak and cyan at 10+ streak. The 3-life protection system allows beginners to practice without score anxiety while the penalty system activates after lives are depleted for advanced training. Perfect for FPS gamers training precise flick shots, graphic designers improving cursor accuracy for detailed work, and anyone wanting faster more accurate mouse control.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-5">
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-purple-50 border-purple-100'}`}>
                    ...
                    <p className={`text-xs leading-relaxed ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                      FPS gamers training precise flick shots, graphic designers improving cursor accuracy, office workers reducing misclicks, and anyone wanting faster more accurate mouse control for everyday computer use.
                    </p>
                  </div>
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-green-50 border-green-100'}`}>
                    ...
                    <p className={`text-xs leading-relaxed ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                      Mouse precision, click accuracy, reaction speed, hand-eye coordination, target tracking, and the ability to maintain accuracy on progressively smaller targets under time pressure.
                    </p>
                  </div>
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-cyan-50 border-cyan-100'}`}>
                    ...
                    <p className={`text-xs leading-relaxed ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                      Score, targets hit count, best reaction time in milliseconds, streak count, smallest target achieved, lives remaining, and best performance records saved locally.
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-yellow-50 border-yellow-100'}`}>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className={`text-sm font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Why Practice Click Accuracy?</h3>
                    </div>
                    <ul className={`text-xs space-y-2 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                      <li className="flex items-start gap-2">
                        ...
                        Single teleporting target trains rapid target acquisition and precision
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-3 h-3 text-yellow-500 mt-0.5 flex-shrink-0" />
                        Shrinking target size ensures progressive difficulty as you improve
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-3 h-3 text-yellow-500 mt-0.5 flex-shrink-0" />
                        Reaction time tracking provides measurable performance data
                      </li>
                    </ul>
                  </div>
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-orange-50 border-orange-100'}`}>
                    ...
                    <ol className={`text-xs space-y-2 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                      ...
                      <li className="flex items-start gap-2">
                        ...
                        Use your 3 lives wisely - each miss costs protection first
                      </li>
                      <li className="flex items-start gap-2">
                      ...
                      <li className="flex items-start gap-2">
                        ...
                        Practice 10-15 minutes daily for best click accuracy improvement
                      </li>
                    </ol>
                  </div>
                </div>
        ...
        {!isFullscreen && (
          <section className="mt-8" aria-label="Related motor and FPS drills">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Link href="/drills/fps/flick-shot-training" className={`group relative overflow-hidden rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${isDarkMode ? 'bg-gray-800 border-gray-700 hover:border-green-500' : 'bg-white border-gray-200 hover:border-green-300'}`}>
                ...
                <div className="p-4">
                  ...
                  <h3 className={`font-semibold text-sm mb-1 ${isDarkMode ? 'text-white group-hover:text-green-400' : 'text-gray-900 group-hover:text-green-600'} transition-colors`}>Flick Shot Trainer</h3>
              ...
              <Link href="/drills/memory/spatial-memory/grid-memorization" className={`group relative overflow-hidden rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${isDarkMode ? 'bg-gray-800 border-gray-700 hover:border-purple-500' : 'bg-white border-gray-200 hover:border-purple-300'}`}>
                ...
                <div className="p-4">
                  ...
                  <h3 className={`font-semibold text-sm mb-1 ${isDarkMode ? 'text-white group-hover:text-purple-400' : 'text-gray-900 group-hover:text-purple-600'} transition-colors`}>Grid Memorization</h3>
              ...
              <Link href="/drills/memory/working-memory/n-back" className={`group relative overflow-hidden rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${isDarkMode ? 'bg-gray-800 border-gray-700 hover:border-orange-500' : 'bg-white border-gray-200 hover:border-orange-300'}`}>
                ...
                <div className="p-4">
                  ...
                  <h3 className={`font-semibold text-sm mb-1 ${isDarkMode ? 'text-white group-hover:text-orange-400' : 'text-gray-900 group-hover:text-orange-600'} transition-colors`}>3-Back Training</h3>
              ...
              <Link href="/drills/memory/spatial-memory/object-location" className={`group relative overflow-hidden rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${isDarkMode ? 'bg-gray-800 border-gray-700 hover:border-cyan-500' : 'bg-white border-gray-200 hover:border-cyan-300'}`}>
                ...
                <div className="p-4">
                  ...
                  <h3 className={`font-semibold text-sm mb-1 ${isDarkMode ? 'text-white group-hover:text-cyan-400' : 'text-gray-900 group-hover:text-cyan-600'} transition-colors`}>Object Location</h3>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="border-t border-gray-800 pt-8 text-center">
                ...
                <p className="text-xs max-w-2xl mx-auto leading-relaxed mb-6">
                  Free online click accuracy drill for precision mouse training. Single teleporting target shrinks from 12px to 7px with streak. 1.5-second teleport interval with reaction time tracking. Perfect for FPS gaming and mouse control practice. No registration required. More free drills at skilldrills.online.
                </p>
                <div className="flex items-center justify-center gap-5 flex-wrap">
                  <button onClick={sharePage} className="text-gray-500 hover:text-white transition-colors" title="Share this drill" aria-label="Share this free click accuracy drill">
