...
export const metadata = {
  title: "Name - Memory Training & Focus Drill | SkillDrills",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/memory/name-face',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Name - Memory Training & Focus Drill | SkillDrills",
    description: "Train face-name association with 30 unique emoji profiles. Memorize for 5 seconds, then pick the correct name from 3 options. No sign-up.",
    url: 'https://skilldrills.online/drills/memory/name-face',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Name - Memory Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function NameFacePage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Name Face drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Name Face?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Name Face drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Name Face drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Name Face?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Name Face drill completely free?</h4>
