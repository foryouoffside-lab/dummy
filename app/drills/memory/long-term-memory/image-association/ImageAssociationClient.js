      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Train visual association memory with 30 unique items featuring emoji visuals and 5 associated words each. 5-second memorization phase then free recall typing. +1 per correct word, -1 per wrong.",
            ...
            "educationalUse": ["Visual Memory", "Word Association", "Long-Term Memory", "Cognitive Training"],
            "learningResourceType": "Interactive Exercise",
            "timeRequired": "PT60S",
            "interactivityType": "active",
            "inLanguage": "en-US",
            "teaches": ["Visual Association", "Word Recall", "Long-Term Memory", "Associative Learning"]
          })
        }}
      />
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className={`text-sm sm:text-base ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                Visual memory • +1 correct / -1 wrong • Auto-advance • 60s
              </p>
            </div>
          </div>
