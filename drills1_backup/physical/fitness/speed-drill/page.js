...
export const metadata = {
  ...
  description: "Free reaction time test and click speed test. Play free in your browser with no downloads or registration required.",
  keywords: [
    "speed drill",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/physical/speed-drill',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Reaction Time Test - Free Speed Drill & Click Speed Test | SkillDrills",
    description: "Free reaction time test and click speed test. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/physical/speed-drill',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Reaction Time Test - Free Speed Drill & Click Speed Test | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function SpeedDrillPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Speed Drill drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Speed Drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Speed Drill drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Speed Drill drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Speed Drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Speed Drill drill completely free?</h4>
