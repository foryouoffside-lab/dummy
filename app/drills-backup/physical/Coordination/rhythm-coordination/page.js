            ...
            <div className="absolute inset-0 flex items-center justify-center bg-white/95 backdrop-blur-sm rounded-xl z-10">
              <div className="bg-white rounded-2xl p-8 text-center max-w-md mx-4 border border-gray-200 shadow-xl">
                ...
                <div className="text-left text-sm text-gray-600 mb-6 space-y-2">
                  <p>ðŸŽµ <span className="font-semibold">Follow the rhythm</span> - Expanding ring indicates beat timing</p>
                  <p>ðŸ–±ï¸ <span className="font-semibold">Click on the beat</span> - Synchronize with the visual pulse</p>
                  <p>âš¡ <span className="font-semibold">60ms elite threshold</span> - Perfect timing = +100 points</p>
                  <p>ðŸ”„ <span className="font-semibold">Dynamic tempo changes</span> - BPM shifts every ~10 beats (50-130 BPM)</p>
                  <p>ðŸ“Š <span className="font-semibold">Scoring</span> - +100 for perfect hit, -50 for miss</p>
                  <p>ðŸ† <span className="font-semibold">Streak system</span> - Consecutive perfect hits build streak</p>
                </div>
                <button
                  onClick={startGame}
