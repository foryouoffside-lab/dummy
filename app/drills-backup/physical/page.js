...
export default function PhysicalDrillsPage() {
  ...
  const categories = [
    { 
      ...
      drills: [
        { name: 'Single Leg Hold', folderName: 'single-leg-hold', difficulty: 'Medium', duration: '2 min', points: 100 },
        { name: 'Dynamic Balance', folderName: 'dynamic-balance', difficulty: 'Hard', duration: '3 min', points: 150 },
        { name: 'Stability Challenge', folderName: 'stability-challenge', difficulty: 'Medium', duration: '2 min', points: 120 }
      ]
    },
    { 
      ...
      drills: [
        { name: 'Drop Catch', folderName: 'drop-catch', difficulty: 'Easy', duration: '1 min', points: 60 },
        { name: 'Quick Dodge', folderName: 'quick-dodge', difficulty: 'Medium', duration: '2 min', points: 100 },
        { name: 'Reaction Chain', folderName: 'reaction-chain', difficulty: 'Hard', duration: '3 min', points: 160 }
      ]
    },
    { 
      name: 'Coordination', 
      ...
      drills: [
        { name: 'Cross Body Movement', folderName: 'cross-body-movement', difficulty: 'Medium', duration: '3 min', points: 120 },
        { name: 'Rhythm Coordination', folderName: 'rhythm-coordination', difficulty: 'Medium', duration: '2 min', points: 110 },
        { name: 'Complex Pattern', folderName: 'complex-pattern', difficulty: 'Hard', duration: '4 min', points: 180 }
      ]
    },
    { 
      name: 'Fitness', 
      ...
      drills: [
        { name: 'Agility Ladder', folderName: 'agility-ladder', difficulty: 'Medium', duration: '3 min', points: 130 },
        { name: 'Jump Sequence', folderName: 'jump-sequence', difficulty: 'Hard', duration: '2 min', points: 140 },
        { name: 'Speed Drill', folderName: 'speed-drill', difficulty: 'Medium', duration: '2 min', points: 120 }
      ]
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <p className="text-2xl font-bold text-gray-900">
              {categories.reduce((acc, cat) => acc + cat.drills.reduce((sum, drill) => sum + drill.points, 0), 0)}
            </p>
                    ...
                    >
                      <div className="p-6">
                        ...
                        <p className="text-sm text-gray-500 mb-4">
                          ...
                          {drill.name === 'Rhythm Coordination' && 'Synchronize movements with rhythmic patterns'}
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
            ...
            Available Physical Training Categories
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-purple-50 rounded-lg p-4">
              <Activity className="w-6 h-6 text-purple-600 mb-2" />
              <p className="font-medium text-purple-900">Balance Training</p>
              <p className="text-xs text-purple-600 mt-1">3 drills available</p>
            </div>
            <div className="bg-yellow-50 rounded-lg p-4">
              <Zap className="w-6 h-6 text-yellow-600 mb-2" />
              <p className="font-medium text-yellow-900">Reflex Training</p>
              <p className="text-xs text-yellow-600 mt-1">3 drills available</p>
            </div>
            <div className="bg-green-50 rounded-lg p-4">
              <Hand className="w-6 h-6 text-green-600 mb-2" />
              <p className="font-medium text-green-900">Coordination</p>
              <p className="text-xs text-green-600 mt-1">3 drills available</p>
            </div>
            <div className="bg-red-50 rounded-lg p-4">
              <Heart className="w-6 h-6 text-red-600 mb-2" />
              <p className="font-medium text-red-900">Fitness</p>
