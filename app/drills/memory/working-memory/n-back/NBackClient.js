      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Classic N-Back working memory task at 3-back difficulty. Letters appear every second - identify if current matches letter from 3 steps back. 60 letters per round with ~23 guaranteed matches. +1 correct, -5 wrong.",
            ...
            "educationalUse": ["Working Memory", "Cognitive Training", "N-Back Task", "Fluid Intelligence"],
            "learningResourceType": "Interactive Exercise",
            "timeRequired": "PT60S",
            "interactivityType": "active",
            "inLanguage": "en-US",
            "teaches": ["Working Memory", "N-Back Performance", "Cognitive Control", "Sustained Attention"]
          })
        }}
      />
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className={`text-sm sm:text-base ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                Working memory • Match/No Match • +1/-5 scoring • 60s challenge
              </p>
            </div>
          </div>
