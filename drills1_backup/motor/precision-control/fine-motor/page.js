...
export const metadata = {
  ...
  description: "Free fine motor skills training online. Play free in your browser with no downloads or registration required.",
  keywords: [
    "fine motor",
    "fine motor training",
    "fine motor game",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/motor/fine-motor',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Fine Motor Skills Training - Free Precision Path Tracking | SkillDrills",
    description: "Free fine motor skills training online. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/motor/fine-motor',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Fine Motor Skills Training - Free Precision Path Tracking | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function FineMotorPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Fine Motor drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Fine Motor?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Fine Motor drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Fine Motor drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Fine Motor?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Fine Motor drill completely free?</h4>
