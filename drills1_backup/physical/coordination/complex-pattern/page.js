...
export const metadata = {
  ...
  description: "Free pattern memory game online. Play free in your browser with no downloads or registration required.",
  keywords: [
    "complex pattern",
    "complex pattern training",
    "complex pattern game",
    "complex pattern test",
    "complex pattern online",
    "free complex pattern",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/physical/complex-pattern',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Pattern Memory Game - Free Coordination Training Online | SkillDrills",
    description: "Free pattern memory game online. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/physical/complex-pattern',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Pattern Memory Game - Free Coordination Training Online | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function ComplexPatternPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Complex Pattern drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Complex Pattern?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Complex Pattern drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Complex Pattern drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Complex Pattern?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Complex Pattern drill completely free?</h4>
