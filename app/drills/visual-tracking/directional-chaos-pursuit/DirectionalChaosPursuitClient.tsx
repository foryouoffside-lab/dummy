...
const STORAGE_KEY = 'skilldrills_visual_tracking_directional_chaos_pursuit_v2';
...
export default function DirectionalChaosPursuitClient() {
  ...
  const sharePage = useCallback(async () => {
    const url = 'https://skilldrills.online/drills/visual-tracking/directional-chaos-pursuit';
    try {
      const canvas = generateSessionCard({
        drillName: 'Directional Chaos Pursuit',
      ...
      const text = 'Directional Chaos Pursuit — Free Visual Tracking & Gaze Calibration Drill!';
      if (typeof navigator !== 'undefined' && navigator.share) {
        try {
          await navigator.share({ title: 'Directional Chaos Pursuit Drill', text, url });
        } catch (e) {}
  ...
  // Canvas Render Loop (Directional Chaos Physics)
  useEffect(() => {
    ...
    const draw = (ts: number) => {
      ...
      // Render Chaotic Velocity Vector Indicator ONLY if math is NOT invisible
      if (!mathInvisible) {
        ...
        ctx.lineTo(
          trackingState.current.px + trackingState.current.vx * 5,
          trackingState.current.py + trackingState.current.vy * 5
        );
        ctx.stroke();
      }
        ...
        <header className="border-b border-white/5 bg-[#080811]/80 backdrop-blur-md sticky top-0 z-50">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            <div className="flex items-center gap-2 text-xs text-slate-400">
              ...
              <span>/</span>
              <span className="text-red-400 font-medium">Directional Chaos Pursuit</span>
            </div>
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 py-6 flex flex-col gap-6">
        ...
        {!isFullscreen && (
          <div className="text-center">
            ...
            <p className="text-xs text-slate-400 mt-1">
              Erratic Directional Tracking & Velocity Reaction
            </p>
          </div>
        )}
        ...
        {!isFullscreen && (
          <div className="[&>div]:!mt-0">
            ...
            <DrillAccordion
              id="about"
              title="About Directional Chaos Pursuit"
              ...
              <div className="space-y-6 font-sans">
                <section>
                  <h4 className="text-base font-bold text-white mb-2">
                    What Is Directional Chaos Pursuit Training?
                  </h4>
                  <p className="text-sm leading-relaxed mb-3 text-gray-300">
                    <strong>Directional Chaos Pursuit Training</strong> exercises foveal tracking agility against continuous chaotic velocity nudges and boundary bounces. In fast-paced sports and esports, visual tracking allows your visual motor cortex to react dynamically to unpredictable target movements.
                  </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="p-4 rounded-xl border border-gray-800 bg-white/[0.02]">
                    ...
                    <p className="text-xs text-gray-300 leading-relaxed">Gamers, athletes, and vision training practitioners looking to build smooth eye tracking control.</p>
                  </div>
                  <div className="p-4 rounded-xl border border-gray-800 bg-white/[0.02]">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-sans">
                <FAQItem q="What is the Directional Chaos Pursuit drill?" a="The Directional Chaos Pursuit drill conditions visual tracking agility by forcing your eyes to follow a target moving with continuous random velocity nudges and boundary bounces." />
