...
import { Activity, AlertCircle, ArrowRight, Award, BarChart3, Calculator, Check, CheckCircle2, ChevronRight, Clock, Cpu, Crosshair, Eye, GraduationCap, Heart, Home, Info, Lightbulb, Lock, Maximize2, Minimize2, Moon, Play, RefreshCw, ScanEye, Sparkles, Star, Sun, Target, Timer, TrendingUp, Trophy, Volume2, VolumeX, Zap } from 'lucide-react';;;
...
export default function AwarenessDrillClient() {
  ...
  const displayReaction = typeof avgReactionTime !== 'undefined' && avgReactionTime > 0 ? `${Math.round(avgReactionTime)}ms` : '-';
