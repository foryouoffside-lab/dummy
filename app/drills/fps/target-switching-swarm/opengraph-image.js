...
export const alt = 'Target Switching Aim Trainer — free browser multi-target aim trainer for Valorant, CS2 and Apex';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            Master rapid multi-target acquisitions, flick transitions, and spray transfers for Valorant, CS2, Apex Legends, and Overwatch.
          </div>
        </div>
