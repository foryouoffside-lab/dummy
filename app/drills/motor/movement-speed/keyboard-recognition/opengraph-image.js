    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            Professional keyboard speed trainer and custom keybind simulator. Sharpen key-to-key reaction time and finger accuracy.
          </div>
        </div>

        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          {['KEYBIND SIMULATOR', 'REACTION SPEED', 'MOTOR TRAINING', 'FREE — NO SIGN-UP'].map((label) => (
            <div
              key={label}
              style={{
                display: 'flex',
