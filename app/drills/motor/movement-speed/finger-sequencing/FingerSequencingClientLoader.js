...
const FingerSequencingClient = dynamic(() => import('./FingerSequencingClient'), {
  ssr: false,
  loading: () => (
...
export default function FingerSequencingClientLoader(props) {
  return <FingerSequencingClient {...props} />;
}
