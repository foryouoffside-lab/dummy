...
export const alt = 'Visual Tracking Speed Test — free browser Reaction Speed drill on SkillDrills';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            {"Click target slides that undergo sudden high-speed burst dash accelerations."}
          </div>
        </div>
