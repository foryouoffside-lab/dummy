...
export const metadata = {
  ...
  description: "Take a free balance test online. Play free in your browser with no downloads or registration required.",
  keywords: [
    "stability challenge",
    "stability challenge training",
    "stability challenge game",
    "stability challenge test",
    "stability challenge online",
    "free stability challenge",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/physical/stability-challenge',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Balance Test Online - Free Cursor Stability Challenge | SkillDrills",
    description: "Take a free balance test online. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/physical/stability-challenge',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Balance Test Online - Free Cursor Stability Challenge | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function StabilityChallengePage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Stability Challenge drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Stability Challenge?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Stability Challenge drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Stability Challenge drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Stability Challenge?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Stability Challenge drill completely free?</h4>
