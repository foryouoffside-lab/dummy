...
export const metadata = {
  title: "Sentence Span - Memory Training & Focus Drill | SkillDrills",
  description: "Train verbal working memory with 30 unique sentences. Play free in your browser with no downloads or registration required.",
  keywords: [
    "sentence span",
    "sentence span training",
    "sentence span game",
    "sentence span test",
    "sentence span online",
    "free sentence span",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/memory/sentence-span',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Sentence Span - Memory Training & Focus Drill | SkillDrills",
    description: "Train verbal working memory with 30 unique sentences. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/memory/sentence-span',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Sentence Span - Memory Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function SentenceSpanPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Sentence Span?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Sentence Span drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Sentence Span drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Sentence Span?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Sentence Span drill completely free?</h4>
