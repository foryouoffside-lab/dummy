...
const guideData = {
  ...
  intro: [
    "Le système des mouvements de poursuite oculaire continue (Smooth Pursuit Eye Movements - SPEM) assure l'orientation continue et fluide de la fovéa centrale sur des objets en déplacement. Relié au cortex visuel temporal médian (MT/V5) et aux structures cérébelleuses, ce circuit en boucle fermée atténue le glissement rétinien (retinal slip) sans recourir aux saccades intempestives (Rashbass, 1961 ; Lisberger, 2010).",
    "Dans les disciplines à haute exigence motrice — sports de tir compétitifs (Overwatch, Apex Legends), sport automobile et tennis —, la capacité à maintenir le réticule sur une trajectoire chaotique sans à-coup saccadique constitue la clé de la précision de visée."
  ],
  benchmarks: {
