const fs = require('fs');
const file = 'C:/Users/sangmesh/Desktop/global-drill-system-nextjs - Copy/app/drills/memory/working-memory/mental-arithmetic/MentalArithmeticClient.js';
let content = fs.readFileSync(file, 'utf8');

// Replace instructions block and everything up to the end of the footer wrapper
const startStr = '        {/* ============ DRILL RULES - KEPT ============ */}';
...
for (let i = startIdx + 1; i < lines.length; i++) {
    if (lines[i].includes('</footer>')) {
        endFooterIdx = i; // This is the final footer
    }
}
// we want the final footer, and the closing brace after it
if (endFooterIdx !== -1) {
    if (endFooterIdx + 1 < lines.length && lines[endFooterIdx + 1].includes(')}')) {
        endFooterIdx++;
    }
}
...
if (startIdx !== -1 && endFooterIdx !== -1) {
          ...
          <section className="mt-12 text-left max-w-4xl mx-auto" aria-label="About this drill">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-xs font-bold text-white uppercase tracking-widest font-mono">
                About Mental Arithmetic Training
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                <p className="text-sm text-gray-400 leading-relaxed mb-6">
                  This free Mental Arithmetic drill trains working memory by forcing you to solve math problems mentally under time pressure. Spanning 4 operations with 8 adaptive difficulty levels, it actively pushes the limits of your numerical fluency and concentration.
                </p>
                ...
                <div className="mb-6 p-5 rounded-xl border border-gray-800 bg-black/40">
                  ...
                  <ul className="space-y-3 text-sm text-gray-400">
                    <li><strong className="text-cyan-400">Solve Mentally:</strong> +, -, ×, ÷ | Type & Submit</li>
                    <li><strong className="text-purple-400">Adaptive Difficulty:</strong> 8 Levels | Increases with Score</li>
                    <li><strong className="text-green-400">Correct Answer:</strong> +1 PTS</li>
                    <li><strong className="text-red-400">Wrong/Timeout:</strong> -1 PTS | 10s per problem</li>
                  </ul>
                </div>
              </div>
              ...
              <div>
                <div className="p-5 rounded-xl border border-gray-800 bg-black/40 mb-6">
                  ...
                  <ol className="space-y-3 list-decimal pl-5 text-sm text-gray-400">
                    <li><strong className="text-white">Calculate:</strong> Mentally solve the math problem presented on screen.</li>
                    <li><strong className="text-white">Input:</strong> Type your answer using your keyboard or on-screen numpad.</li>
                    <li><strong className="text-white">Submit:</strong> Press Enter or Submit to lock in your answer within 10 seconds.</li>
                  </ol>
                </div>
                ...
                <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-1">Students preparing for tests, professionals needing quick mental math, seniors maintaining cognitive function, and anyone wanting better numerical fluency.</p>
                    </div>
                    <div>
                      <h4 className="text-sm font-bold text-gray-200">What skills are improved?</h4>
                      <p className="text-xs text-gray-400 mt-1">Working memory, mental calculation speed, numerical processing, and concentration under time pressure.</p>
                    </div>
                  </div>
                </div>
              </div>
  ...
  return (
    ...
    console.log('Fixed MentalArithmeticClient.js successfully.');
} else {
