...
export const alt = 'Symbol Matching — free browser Symbol Digit Modality Test (SDMT) cognitive drill';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            Train Symbol Digit Modality lookup speed, visual search, and working memory translation.
          </div>
        </div>

        {/* Stat strip */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          {['45-SECOND DRILL', 'SDMT PARADIGM', '15 DIFFICULTY LEVELS', 'FREE — NO SIGN-UP'].map((label) => (
            <div
              key={label}
              style={{
                display: 'flex',
