...
export const metadata = {
  title: "Tower of Hanoi - Cognitive Training & Focus Drill | SkillDrills",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/cognitive/tower-of-hanoi',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Tower of Hanoi - Cognitive Training & Focus Drill | SkillDrills",
    description: "Master the classic Tower of Hanoi with progressive 3-8 disk levels. Perfect move celebrations, efficiency tracking, no penalties. No sign-up.",
    url: 'https://skilldrills.online/drills/cognitive/tower-of-hanoi',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Tower of Hanoi - Cognitive Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function TowerOfHanoiPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Tower Of Hanoi drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Tower Of Hanoi?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Tower Of Hanoi drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Tower Of Hanoi drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Tower Of Hanoi?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Tower Of Hanoi drill completely free?</h4>
