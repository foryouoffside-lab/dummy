...
export const metadata = {
  ...
  keywords: [
    ...
    "image association test",
    "image association online",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/memory/image-association',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Image Association - Visual Memory | SkillDrills",
    description: "Train visual association with 30 items, 5 words each. Memorize for 5 seconds, then free recall type all words. Green/red feedback. No sign-up.",
    url: 'https://skilldrills.online/drills/memory/image-association',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Image Association - Visual Memory | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function ImageAssociationPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Image Association?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Image Association drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Image Association drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Image Association?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Image Association drill completely free?</h4>
