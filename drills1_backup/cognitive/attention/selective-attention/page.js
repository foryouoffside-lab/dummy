...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/cognitive/selective-attention',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Selective Attention - Visual Search | SkillDrills",
    description: "Train selective attention with visual search. Find items matching color and shape among distractors. Adaptive speed 900-2000ms. 60-second challenge. No sign-up.",
    url: 'https://skilldrills.online/drills/cognitive/selective-attention',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Selective Attention - Visual Search | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function SelectiveAttentionPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Selective Attention?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Selective Attention drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Selective Attention drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Selective Attention?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Selective Attention drill completely free?</h4>
