...
export const metadata = {
  title: "FPS Awareness Trainer - 180° Peripheral Vision Drill | SkillDrills",
  description: "Train peripheral vision, situational awareness, and rapid target detection with this free FPS Awareness Trainer. Practice 180° target acquisition and reaction speed online.",
  keywords: [
    "180 degree awareness",
    "180 degree awareness training",
    "180 degree awareness game",
    "180 degree awareness test",
    "180 degree awareness online",
    "free 180 degree awareness",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "FPS Awareness Trainer - 180° Peripheral Vision Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function AwarenessDrillPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the 180 Degree Awareness drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in 180 Degree Awareness?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the 180 Degree Awareness drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the 180 Degree Awareness drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in 180 Degree Awareness?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the 180 Degree Awareness drill completely free?</h4>
