...
export const metadata = {
  ...
  description: "Interpolate path trajectory of a moving cyan shadow and execute ballistic gaze shifts... Play free in your browser with no downloads or registration required.",
  keywords: [
    "predictive pursuit",
    "predictive pursuit training",
    "predictive pursuit game",
    "predictive pursuit test",
    "predictive pursuit online",
    "free predictive pursuit",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Predictive Pursuit - Visual Pursuit & Tracking Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function PredictivePursuitPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Predictive Pursuit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Predictive Pursuit drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Predictive Pursuit drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Predictive Pursuit?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Predictive Pursuit drill completely free?</h4>
