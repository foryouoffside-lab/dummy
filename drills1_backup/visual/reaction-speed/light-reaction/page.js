...
export const metadata = {
  title: "Light Reaction - Visual Training & Focus Drill | SkillDrills",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/visual/light-reaction',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Light Reaction - Visual Training & Focus Drill | SkillDrills",
    description: "Click when ball flashes white. Adaptive 100-200ms window, raw mouse input, random 1-3s intervals. Millisecond reaction tracking. No sign-up.",
    url: 'https://skilldrills.online/drills/visual/light-reaction',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Light Reaction - Visual Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function StrobeLatencyPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Light Reaction drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Light Reaction?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Light Reaction drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Light Reaction drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Light Reaction?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Light Reaction drill completely free?</h4>
