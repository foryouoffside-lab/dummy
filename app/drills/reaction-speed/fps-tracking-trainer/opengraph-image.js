...
export const alt = 'FPS Tracking Trainer — free browser Reaction Speed drill on SkillDrills';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            {"Stabilize gaze and click targets executing erratic, human-like horizontal strafes."}
          </div>
        </div>
