...
export const metadata = {
  ...
  description: "Free mouse accuracy test online. Play free in your browser with no downloads or registration required.",
  keywords: [
    "click accuracy",
    "click accuracy training",
    "click accuracy game",
    "click accuracy test",
    "click accuracy online",
    "free click accuracy",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/motor/click-accuracy',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Mouse Accuracy Test - Free Click Accuracy Drill | SkillDrills",
    description: "Free mouse accuracy test online. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/motor/click-accuracy',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Mouse Accuracy Test - Free Click Accuracy Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function ClickAccuracyPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Click Accuracy drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Click Accuracy?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Click Accuracy drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Click Accuracy drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Click Accuracy?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Click Accuracy drill completely free?</h4>
