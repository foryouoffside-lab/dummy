...
export const metadata = {
  ...
  description: "Free single leg balance exercises online. Play free in your browser with no downloads or registration required.",
  keywords: [
    "single leg hold",
    "single leg hold training",
    "single leg hold game",
    "single leg hold test",
    "single leg hold online",
    "free single leg hold",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/physical/single-leg-hold',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Single Leg Balance Exercises - Free Balance Training Online | SkillDrills",
    description: "Free single leg balance exercises online. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/physical/single-leg-hold',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Single Leg Balance Exercises - Free Balance Training Online | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function SingleLegEquilibriumPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Single Leg Hold drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Single Leg Hold?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Single Leg Hold drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Single Leg Hold drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Single Leg Hold?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Single Leg Hold drill completely free?</h4>
