...
const guideData = {
  ...
  intro: [
    "O teste Entropic Grid baseia-se na teoria da integração de características (Treisman & Gelade, 1980) e nos modelos de busca guiada (Wolfe, 2007). Em uma matriz 10x10 de 100 células, o cérebro precisa filtrar distratores que sofrem transições periódicas a cada 700 milissegundos para localizar o código-alvo designado.",
    "Esse exercício exige sincronização entre o sistema atencional ventral (detecção de novidade) e o sistema dorsal (orientação espacial), suprimindo ruídos ambientais concorrentes e acelerando a velocidade de processamento perceptivo."
  ],
  benchmarks: {
