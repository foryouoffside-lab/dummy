...
export const metadata = {
  title: "Staircase Step - Visual Tracking Training & Focus Drill | SkillDrills",
  description: "Track stepped trajectories combining horizontal slides with rapid vertical snaps. Train visual pursuit tracking and coordinate re-acquisition speeds. No sign-up required.",
  keywords: [
    "staircase step",
    "staircase step training",
    "staircase step game",
    "staircase step test",
    "staircase step online",
    "free staircase step",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Staircase Step - Visual Tracking Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function StaircaseStepPage() {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Staircase Step" }
            ]
          })
        }}
      />
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Staircase Step?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Staircase Step drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Staircase Step drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Staircase Step?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Staircase Step drill completely free?</h4>
