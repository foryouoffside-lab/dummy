const fs = require('fs');
const file = 'C:/Users/sangmesh/Desktop/global-drill-system-nextjs - Copy/app/drills/memory/spatial-memory/grid-memorization/GridMemorizationClient.js';
let content = fs.readFileSync(file, 'utf8');

// Replace instructions block and everything up to the end of the footer wrapper
const startStr = '        {/* DRILL RULES & SCORING */}';
...
if (startIdx !== -1 && endFooterIdx !== -1) {
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                <p className="text-sm text-gray-400 leading-relaxed mb-6">
                  This free Grid Memorization drill trains visuospatial working memory and pattern retention. You are shown an illuminated pattern on a grid for a few seconds. Once it disappears, you must recreate it flawlessly. As you succeed, the grid scales in size, actively pushing the limits of your spatial recall.
                </p>
                ...
                <div className="mb-6 p-5 rounded-xl border border-gray-800 bg-black/40">
                  ...
                  <ul className="space-y-3 text-sm text-gray-400">
                    <li><strong className="text-indigo-400">Observe:</strong> Illuminated Pattern | Shown for 5 Seconds</li>
                    <li><strong className="text-purple-400">Adaptive Grid Sizing:</strong> 4x4 -> 5x5 | Scales on Performance</li>
                    <li><strong className="text-green-400">Recall Flawlessly:</strong> +10 PTS | +5s Time</li>
                    <li><strong className="text-red-400">Wrong Cell:</strong> -5 PTS | -3s Time (Instant Reset)</li>
                  </ul>
                </div>
              </div>
              ...
              <div>
                <div className="p-5 rounded-xl border border-gray-800 bg-black/40 mb-6">
                  ...
                  <ol className="space-y-3 list-decimal pl-5 text-sm text-gray-400">
                    <li><strong className="text-white">Encode:</strong> When the pattern lights up, quickly visualize its shape or group the cells mentally.</li>
                    <li><strong className="text-white">Recall:</strong> Recreate the exact pattern by clicking the correct cells in any order.</li>
                    <li><strong className="text-white">Survive:</strong> Maintain high accuracy to keep your timer alive. Mistakes cost you time and points.</li>
                  </ol>
                </div>
                ...
                <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-1">Athletes needing strong field awareness, architects/designers, gamers, and anyone wanting to benchmark their visuospatial capacity.</p>
                    </div>
                    <div>
                      <h4 className="text-sm font-bold text-gray-200">What skills are improved?</h4>
                      <p className="text-xs text-gray-400 mt-1">Visuospatial working memory, pattern recognition, spatial encoding speed, and concentration under time pressure.</p>
                    </div>
                  </div>
                </div>
              </div>
  ...
  return (
    ...
    console.log('Fixed GridMemorizationClient.js successfully.');
} else {
