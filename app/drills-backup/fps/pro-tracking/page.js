...
import { 
  ...
  Sun, Moon, Eye, Timer, Trophy, Crosshair, Zap, Activity, Award, Info
} from 'lucide-react';
    ...
    class Ball {
      ...
      draw() {
        ...
        if (this.isTarget) {
          ...
          ctx.shadowBlur = 0;
          ctx.fillStyle = isBoxDarkMode ? '#2a2a2a' : '#d1d5db';
          ctx.fill();
      ...
      for (let i = 0; i < ballsRef.current.length; i++) {
        for (let j = i + 1; j < ballsRef.current.length; j++) {
          ...
          if (dist < minDist && dist > 0) {
            ...
            const moveX = Math.cos(angle) * (minDist - dist) * 0.3;
            const moveY = Math.sin(angle) * (minDist - dist) * 0.3;
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>Track green target â€¢ Target switches every 1.8s</p>
              </div>
            </div>
            ...
            <div className={`rounded-xl border overflow-hidden ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
              <div className={`px-4 py-3 border-b ${isDarkMode ? 'border-gray-700 bg-gray-800/50' : 'border-gray-200 bg-gray-50'}`}>
                <div className="flex items-center gap-2">
                  ...
                  <h3 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Target Tracking Rules</h3>
                </div>
              </div>
              <div className="p-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        <span className="font-semibold text-green-500">Track the GREEN target</span> â€¢ Ignore gray decoys
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        <span className="font-semibold text-blue-500">Target switches every 1.8 seconds</span> â€¢ Stay alert
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        <span className="font-semibold text-purple-500">Speed increases with each switch</span> â€¢ Adaptive difficulty
                      </p>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        <span className="font-semibold text-cyan-500">85%+ = +2pts â€¢ 60%+ = +1pt</span> â€¢ Build combos
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
                      <div className="w-5 h-5 rounded-full bg-red-500 flex items-center justify-center text-white text-xs font-bold mt-0.5">5</div>
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        <span className="font-semibold text-red-500">&lt;30% = -1pt â€¢ Resets combo</span>
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
