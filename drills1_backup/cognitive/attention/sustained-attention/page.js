...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/cognitive/sustained-attention',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Sustained Attention - Vigilance Drill | SkillDrills",
    description: "Train sustained attention with target detection. Memorize a number and click when it appears among flashing digits. Adaptive 300-500ms. No sign-up.",
    url: 'https://skilldrills.online/drills/cognitive/sustained-attention',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Sustained Attention - Vigilance Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function SustainedAttentionPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Sustained Attention?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Sustained Attention drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Sustained Attention drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Sustained Attention?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Sustained Attention drill completely free?</h4>
