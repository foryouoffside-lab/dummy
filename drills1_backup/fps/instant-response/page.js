...
export const metadata = {
  ...
  description: "Free reaction time test for FPS gaming. Play free in your browser with no downloads or registration required.",
  keywords: [
    "instant response",
    "instant response training",
    "instant response game",
    "instant response test",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Reaction Time Test FPS - Free Raw Reflex Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function InstantResponsePage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Instant Response drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Instant Response?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Instant Response drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Instant Response drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Instant Response?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Instant Response drill completely free?</h4>
