              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8 mb-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li><Link href="/drills/productivity" className="hover:text-pink-400 transition-colors">Productivity (10)</Link></li>
                    <li><Link href="/drills/mental-fitness" className="hover:text-pink-400 transition-colors">Mental Fitness (6)</Link></li>
