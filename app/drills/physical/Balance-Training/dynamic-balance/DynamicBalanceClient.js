    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading dynamic balance drill...</p>
        </div>
      </div>
    );
  }
    ...
    <div className={`min-h-screen select-none ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "Dynamic Balance Elite",
            "url": "https://skilldrills.online/drills/physical/Balance-Training/dynamic-balance",
            "description": "Hand-eye coordination and motor control drill. Track a Lissajous-trajectory target with your cursor. Earn points for sustained tracking. 60-second challenge with accuracy metrics.",
            ...
            "educationalUse": ["Motor Control", "Hand-Eye Coordination", "Tracking Precision", "Balance Training"],
            "learningResourceType": "Interactive Exercise",
            "timeRequired": "PT60S",
            "interactivityType": "active",
            "inLanguage": "en-US",
            "teaches": ["Motor Control", "Hand-Eye Coordination", "Tracking Accuracy", "Sustained Attention"]
          })
        }}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className={`text-sm sm:text-base ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                Track the moving target • 2s tracking = +1 point • 60-second challenge
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-2 flex-shrink-0">
            {gameState === 'playing' && (
              <button 
                ...
                title="Reset session"
                aria-label="Reset balance drill"
              >
        ...
        <section className="sr-only" aria-label="Drill description for search engines">
          <h2>Dynamic Balance Elite - Motor Control & Tracking Precision Training</h2>
          <p>
            Train your hand-eye coordination and fine motor control by tracking a moving target with your mouse cursor.
            The target moves in a Lissajous trajectory pattern across the screen.
            Keep your cursor inside the ring to build tracking time - every 2 seconds of sustained tracking earns +1 point.
            Losing the target resets your tracking timer and applies a -1 point penalty.
            60-second timed challenge that tracks score, accuracy percentage, and best streak.
          </p>
        </section>
            ...
            <div className={`absolute inset-0 flex items-center justify-center backdrop-blur-sm rounded-xl z-40 ${isBoxDarkMode ? 'bg-gray-900/95' : 'bg-white/95'}`}>
              <div className={`rounded-2xl p-6 sm:p-8 text-center max-w-md mx-4 shadow-xl border ${isBoxDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                ...
                <p className={`mb-2 ${isBoxDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  60-second challenge • 2s tracking = +1 point
                </p>
                <p className={`mb-6 text-sm ${isBoxDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                  Keep your cursor inside the moving ring. Green ring = tracking. Lose target = -1 point penalty.
                </p>
                <button 
                  onClick={startGame} 
                  ...
                  aria-label="Start dynamic balance training"
                >
                  Start Training
                </button>
              </div>
            ...
            <div className={`absolute inset-0 flex items-center justify-center backdrop-blur-sm rounded-xl z-40 ${isBoxDarkMode ? 'bg-gray-900/95' : 'bg-white/95'}`}>
              <div className={`rounded-2xl p-6 sm:p-8 shadow-xl border w-full max-w-[520px] mx-4 ${isBoxDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                ...
                <p className={`text-center text-sm mb-6 ${isBoxDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                  Regular tracking practice improves hand-eye coordination and fine motor control.
                </p>
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                  ...
                  <ResultCard label="Accuracy" value={trackingAccuracy} unit="%" icon={<Activity className="w-4 h-4" />} color="emerald" isDark={isBoxDarkMode} />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Target moves in a <span className="font-semibold text-orange-500">Lissajous trajectory</span> pattern</p>
                    </div>
                    <div className="flex items-start gap-2">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Green ring = tracking • <span className="font-semibold text-yellow-500">Red ring = target lost</span></p>
                    </div>
                  </div>
                </div>
                <div className={`mt-4 pt-3 border-t flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 text-xs ${isDarkMode ? 'border-gray-700 text-gray-400' : 'border-gray-200 text-gray-500'}`}>
                  <span>🎯 Track continuously to earn points • Best Score saves locally</span>
                  <span>⚡ Lose target = -1pt penalty • Accuracy tracks frame-by-frame</span>
                </div>
              </div>
            </div>
          </footer>
