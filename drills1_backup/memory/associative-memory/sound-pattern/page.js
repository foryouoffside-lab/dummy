...
export const metadata = {
  title: "Sound Pattern - Memory Training & Focus Drill | SkillDrills",
  ...
  keywords: [
    "sound pattern",
    "sound pattern training",
    "sound pattern game",
    "sound pattern test",
    "sound pattern online",
    "free sound pattern",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/memory/sound-pattern',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Sound Pattern - Memory Training & Focus Drill | SkillDrills",
    description: "Train auditory memory with 30 unique rhythmic beat sequences. Listen to patterns, then reproduce using Tap and Rest buttons. No sign-up.",
    url: 'https://skilldrills.online/drills/memory/sound-pattern',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Sound Pattern - Memory Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function SoundPatternPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Sound Pattern?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Sound Pattern drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Sound Pattern drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Sound Pattern?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Sound Pattern drill completely free?</h4>
