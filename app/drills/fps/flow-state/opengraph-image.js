...
export const alt = 'Flow State Trainer — free browser concentration endurance and focus tracking trainer';
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ display: 'flex', itemsCenter: 'center', gap: 16 }}>
          <div
            style={{
              width: 44,
              height: 44,
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            Train concentration endurance, sustained attention, and flow state tracking for FPS games and cognitive deep work.
          </div>
        </div>
