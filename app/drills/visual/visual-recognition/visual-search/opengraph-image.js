...
export const alt = 'Visual Search — free browser Visual Training drill on SkillDrills';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            {"Find the letter C among 160 O distractors in a 16x10 grid. +1 per find, -1 wrong."}
          </div>
        </div>
