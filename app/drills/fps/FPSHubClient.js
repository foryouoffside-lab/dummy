...
import { 
  ...
  Gamepad2, Home, ChevronRight, Cpu
} from "lucide-react";
...
const fpsCategories = [
  {
    ...
    drills: [
      ...
      { name: "Micro-Correction Precision", folderName: "micro-correction-precision", difficulty: "Advanced", duration: "60s", description: "Precision micro-correction trainer: hit anchor then snap-click the adjacent micro-target" },
  ...
  },
  {
    ...
    drills: [
      ...
      { name: "Anti-Strafing Jitter Duel", folderName: "anti-strafe-jitter-duel", difficulty: "Expert", duration: "60s", description: "Erratic close-range tracking simulator mimicking human ADAD strafes with high-rate physics jitter" },
      { name: "Anti-Zigzag Movement Trainer", folderName: "anti-zigzag-movement-trainer", difficulty: "Advanced", duration: "60s", description: "Track evasive human-like targets executing aggressive zig-zag strafing, pauses, jumps, slides, and fake-outs." },
    ]
  },
  {
