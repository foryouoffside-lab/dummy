...
export const metadata = {
  title: 'Reactive Strafe Pursuit - Visual Pursuit & Tracking Drill | SkillDrills',
  ...
  keywords: ['reactive strafe pursuit', 'visual tracking drill', 'smooth pursuit eye training', 'saccadic eye movement test', 'visual processing speed', 'foveal tracking', 'esports vision training', 'athletic vision drill'],
  openGraph: {
    title: 'Reactive Strafe Pursuit - Visual Pursuit & Tracking Drill | SkillDrills',
    description: 'Stabilize horizontal gaze pursuit against erratic, human-like target strafes. Train visual pursuit tracking and coordinate re-acquisition speeds. No sign-up required.',
    type: 'article',
