...
export const alt = 'Sequence Aim Trainer — free browser mouse accuracy and finger speed test';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            Master mouse accuracy and target sequencing. Click ordered nodes from largest to smallest under dynamic time pressure.
          </div>
        </div>
