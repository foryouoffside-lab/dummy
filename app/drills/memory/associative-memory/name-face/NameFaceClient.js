      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Train face-name association memory with 30 unique profiles featuring emoji faces, names, and roles. Adaptive difficulty increases from 3 to 8 profiles. 5-second memorization phase with 3-option multiple choice recall.",
            ...
            "educationalUse": ["Face-Name Association", "Associative Memory", "Social Memory", "Cognitive Training"],
            "learningResourceType": "Interactive Exercise",
            "timeRequired": "PT60S",
            "interactivityType": "active",
            "inLanguage": "en-US",
            "teaches": ["Name Recall", "Face Association", "Associative Memory", "Social Recognition"]
          })
        }}
      />
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className={`text-sm sm:text-base ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                Associative recall • +1 correct / -1 wrong • Adaptive profiles • 60s
              </p>
            </div>
          </div>
