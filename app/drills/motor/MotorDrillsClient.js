...
export default function MotorDrillsClient() {
  ...
  // splits the page into three separate walls of cards.
        ...
        <Reveal>
          <div className="mb-8 bg-surface-1 border border-hairline rounded-3xl p-6 sm:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden backdrop-blur-xl shadow-xl">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h1 className="text-2xl sm:text-4xl font-extrabold text-ink-1 tracking-tight uppercase">{t('hubs.motor.h1', 'Mouse Precision & Motor Drills')}</h1>
                <p className="text-ink-2 mt-2 text-sm sm:text-base max-w-xl leading-relaxed">
                  {t('hubs.motor.desc', 'Refine micro-aim adjustments, drag mechanics, target intercept precision, and click cadence ratios.')}
                </p>
              </div>
            </div>
          </div>
