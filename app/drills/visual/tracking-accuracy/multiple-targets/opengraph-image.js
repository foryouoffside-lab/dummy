...
export const alt = 'Ghost-Link Tracking — free browser Visual Training drill on SkillDrills';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            {"Memorize 4 green targets among 11 balls. Track for 60s, then identify them. +5 per correct."}
          </div>
        </div>

        {/* Stat strip */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          {['60S DRILL', 'EXPERT', 'VISUAL TRAINING', 'FREE — NO SIGN-UP'].map((label) => (
            <div
              key={label}
              style={{
                display: 'flex',
