...
export const metadata = {
  title: "Sound Reaction - Visual Training & Focus Drill | SkillDrills",
  ...
  keywords: [
    "sound reaction",
    "sound reaction training",
    "sound reaction game",
    "sound reaction test",
    "sound reaction online",
    "free sound reaction",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/visual/sound-reaction',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Sound Reaction - Visual Training & Focus Drill | SkillDrills",
    description: "Train auditory reaction speed with dual pitch cues. High pitch (1200Hz) = Green, Low pitch (250Hz) = Red. Adaptive 300-1000ms window. No sign-up.",
    url: 'https://skilldrills.online/drills/visual/sound-reaction',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Sound Reaction - Visual Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function NeuroSwitchPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Sound Reaction drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Sound Reaction?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Sound Reaction drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Sound Reaction drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Sound Reaction?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Sound Reaction drill completely free?</h4>
