...
export const metadata = {
  title: "Path Tracing - Memory Training & Focus Drill | SkillDrills",
  description: "Train spatial memory with animated dot paths on expanding 3x3 to 7x7 grids. Play free in your browser with no downloads or registration required.",
  keywords: [
    "path tracing",
    "path tracing training",
    "path tracing game",
    "path tracing test",
    "path tracing online",
    "free path tracing",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/memory/path-tracing',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Path Tracing - Memory Training & Focus Drill | SkillDrills",
    description: "Train spatial memory with animated dot paths on expanding 3x3 to 7x7 grids. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/memory/path-tracing',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Path Tracing - Memory Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function PathTracingPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Path Tracing?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Path Tracing drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Path Tracing drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Path Tracing?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Path Tracing drill completely free?</h4>
