...
export const metadata = {
  ...
  keywords: ['directional chaos pursuit', 'visual tracking drill', 'smooth pursuit eye training', 'saccadic eye movement test', 'visual processing speed', 'foveal tracking', 'esports vision training', 'athletic vision drill'],
  openGraph: {
    title: 'Directional Chaos Pursuit - Visual Pursuit & Tracking Drill | SkillDrills',
    description: 'Track a bouncing target subjected to continuous chaotic velocity nudges. Train visual pursuit tracking and coordinate re-acquisition speeds. No sign-up required.',
    type: 'article',
    ...
    images: [{
      ...
      width: 512,
      height: 512,
      alt: 'Directional Chaos Pursuit Drill',
    }],
  },
  twitter: {
