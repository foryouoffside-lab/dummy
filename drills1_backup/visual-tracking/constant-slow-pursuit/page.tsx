...
export const metadata = {
  title: "Constant Slow Pursuit - Visual Pursuit & Tracking Drill | SkillDrills",
  ...
  keywords: [
    ...
    "constant slow pursuit training",
    "constant slow pursuit game",
    "constant slow pursuit test",
    "constant slow pursuit online",
    "free constant slow pursuit",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Constant Slow Pursuit - Visual Pursuit & Tracking Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function ConstantSlowPursuitPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Constant Slow Pursuit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Constant Slow Pursuit drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Constant Slow Pursuit drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Constant Slow Pursuit?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Constant Slow Pursuit drill completely free?</h4>
