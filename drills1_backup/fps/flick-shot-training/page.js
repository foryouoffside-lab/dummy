...
export const metadata = {
  title: "Flick Aim Trainer - Free Online FPS Aim Practice | SkillDrills",
  ...
  keywords: [
    "flick shot training",
    "flick shot training training",
    "flick shot training game",
    "flick shot training test",
    "flick shot training online",
    "free flick shot training",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Flick Aim Trainer - Free Online FPS Aim Practice | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function FlickShotPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Flick Shot Training drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Flick Shot Training?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Flick Shot Training drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Flick Shot Training drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Flick Shot Training?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Flick Shot Training drill completely free?</h4>
