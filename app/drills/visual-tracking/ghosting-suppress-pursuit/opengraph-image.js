...
export const alt = 'Ghosting Suppress Pursuit — Eye Fixation Stability Training | SkillDrills';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            {"Train foveal tracking precision by suppressing motion ghosting artifacts."}
          </div>
        </div>
