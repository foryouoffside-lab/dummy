...
export const metadata = {
  ...
  description: "Click RED, GREEN, BLUE targets matching the priority rule. Play free in your browser with no downloads or registration required.",
  keywords: [
    "priority sorting",
    "priority sorting training",
    "priority sorting game",
    "priority sorting test",
    "priority sorting online",
    "free priority sorting",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/cognitive/priority-sorting',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Priority Sorting - Task Prioritization | SkillDrills",
    description: "Click RED, GREEN, BLUE targets matching the priority rule. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/cognitive/priority-sorting',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Priority Sorting - Task Prioritization | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function PrioritySortingPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Priority Sorting?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Priority Sorting drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Priority Sorting drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Priority Sorting?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Priority Sorting drill completely free?</h4>
