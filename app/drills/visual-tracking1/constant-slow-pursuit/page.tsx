...
export const metadata = {
  ...
  keywords: ['constant slow pursuit', 'visual tracking drill', 'smooth pursuit eye training', 'saccadic eye movement test', 'visual processing speed', 'foveal tracking', 'esports vision training', 'athletic vision drill'],
  openGraph: {
    title: 'Constant Slow Pursuit - Visual Pursuit & Tracking Drill | SkillDrills',
    description: 'Condition foveal pursuit along a continuous, visible Lissajous curve at low velocity. Train visual pursuit tracking and coordinate re-acquisition speeds. No sign-up required.',
    type: 'article',
