...
export const alt = 'Saccadic Gallery — free browser Reaction Speed drill on SkillDrills';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            {"Sequence-based ballistic eye shifts. Click glowing targets flashing in a zig-zag gallery pattern."}
          </div>
        </div>

        {/* Stat strip */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          {['45S DRILL', 'INTERMEDIATE', 'REACTION SPEED', 'FREE — NO SIGN-UP'].map((label) => (
            <div
              key={label}
              style={{
                display: 'flex',
