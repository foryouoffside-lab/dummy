const fs = require('fs');
const file = 'C:/Users/sangmesh/Desktop/global-drill-system-nextjs - Copy/app/drills/memory/short-term-memory/word-recall/WordRecallClient.js';
...
for (let i = startIdx + 1; i < lines.length; i++) {
    if (lines[i].includes('</footer>')) {
        endFooterIdx = i;
        // Move down past the closing wrapper `        )}` if present
...
if (startIdx !== -1 && endFooterIdx !== -1) {
              ...
              <div>
                ...
                <div className="mb-6 p-5 rounded-xl border border-gray-800 bg-black/40">
                  ...
                  <ul className="space-y-3 text-sm text-gray-400">
                    <li><strong className="text-green-400">Correct Word:</strong> +3 Points | Per Match</li>
                    <li><strong className="text-pink-400">Perfect Round:</strong> +15s Time | Adds 1 Word</li>
                    <li><strong className="text-red-400">Error Made:</strong> -5s Time & -3 PTS | Per Miss/Extra</li>
                    <li><strong className="text-orange-400">Timeout:</strong> Game Over | 0s Remaining</li>
                  </ul>
                </div>
              </div>
              ...
              <div>
                <div className="p-5 rounded-xl border border-gray-800 bg-black/40 mb-6">
                  ...
                  <ol className="space-y-3 list-decimal pl-5 text-sm text-gray-400">
                    <li><strong className="text-white">Memorize:</strong> A sequence of words will appear briefly. Pay close attention to each word.</li>
                    <li><strong className="text-white">Recall:</strong> Click the words from the grid in the exact order they appeared.</li>
                ...
                <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-1">Students improving study retention, professionals needing strong verbal recall, seniors maintaining cognitive function, and anyone wanting to benchmark working memory capacity.</p>
                    </div>
                    <div>
                      <h4 className="text-sm font-bold text-gray-200">What skills are improved?</h4>
                      <p className="text-xs text-gray-400 mt-1">Verbal short-term memory, working memory capacity, sequential word processing, and concentration under time pressure.</p>
                    </div>
                  </div>
                </div>
              </div>
    ...
    // Check if RelatedCard exists and add if missing
  ...
  return (
    ...
    console.log('Fixed WordRecallClient.js successfully.');
} else {
