...
const guideData = {
  ...
  intro: [
    "El sistema de movimientos oculares de persecución suave (Smooth Pursuit Eye Movements - SPEM) rige la alineación fluida y sin saltos de la fóvea central sobre objetivos visuales continuos. Mediante bucles de retroalimentación corticales y cerebelares (área MT/V5 y flóculo cerebeloso), este mecanismo anula el deslizamiento retiniano (retinal slip) sin requerir saltos sacádicos bruscos (Rashbass, 1961; Lisberger, 2010).",
    "En contextos de alta velocidad —como tiradores competitivos en primera persona (Overwatch, Apex Legends), automovilismo y tenis—, la habilidad para sujetar la retícula sobre trayectorias dinámicas sin sacadas parásitas es determinante para la exactitud motriz."
  ],
  benchmarks: {
