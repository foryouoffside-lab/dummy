...
export const metadata = {
  ...
  keywords: [
    "rapid object id",
    "rapid object id training",
    "rapid object id game",
    "rapid object id test",
    "rapid object id online",
    "free rapid object id",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/visual/rapid-object-id',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Rapid Object ID - Shape Recognition | SkillDrills",
    description: "Train rapid shape recognition with adaptive 50-300ms flash. Circle=Left/A, Square=Right/D. Keyboard support. 3 lives, reaction tracking. No sign-up.",
    url: 'https://skilldrills.online/drills/visual/rapid-object-id',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Rapid Object ID - Shape Recognition | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function RapidObjectIdPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Rapid Object Id drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Rapid Object Id?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Rapid Object Id drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Rapid Object Id drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Rapid Object Id?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Rapid Object Id drill completely free?</h4>
