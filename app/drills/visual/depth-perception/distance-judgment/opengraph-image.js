...
export const alt = 'Distance Judgment Lab — free browser Visual Training drill on SkillDrills';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            {"Intercept a moving sphere at the target depth. Perfect <5%, Close <15%, Far 15%+ error."}
          </div>
        </div>
