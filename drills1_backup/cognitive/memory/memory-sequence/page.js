...
export const metadata = {
  ...
  description: "Train spatial working memory by repeating patterns on expanding 4x4 to 7x7 grids. Play free in your browser with no downloads or registration required.",
  keywords: [
    "memory sequence",
    "memory sequence training",
    "memory sequence game",
    "memory sequence test",
    "memory sequence online",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/cognitive/memory-sequence',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Memory Sequence - Working Memory | SkillDrills",
    description: "Train spatial working memory by repeating patterns on expanding 4x4 to 7x7 grids. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/cognitive/memory-sequence',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Memory Sequence - Working Memory | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function MemorySequencePage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Memory Sequence?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Memory Sequence drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Memory Sequence drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Memory Sequence?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Memory Sequence drill completely free?</h4>
