...
export const metadata = {
  ...
  keywords: [
    "distraction fighter",
    "distraction fighter training",
    "distraction fighter game",
    "distraction fighter test",
    "distraction fighter online",
    "free distraction fighter",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/cognitive/distraction-fighter',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Distraction Fighter - Stroop Test | SkillDrills",
    description: "Train cognitive inhibition with Stroop effect. Identify ink colors while ignoring conflicting word meanings. 8 colors, 60-second challenge. No sign-up.",
    url: 'https://skilldrills.online/drills/cognitive/distraction-fighter',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Distraction Fighter - Stroop Test | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function DistractionFighterPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Distraction Fighter drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Distraction Fighter?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Distraction Fighter drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Distraction Fighter drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Distraction Fighter?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Distraction Fighter drill completely free?</h4>
