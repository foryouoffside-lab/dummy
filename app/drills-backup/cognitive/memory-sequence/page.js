            ...
            <div className={`absolute inset-0 flex items-center justify-center backdrop-blur-sm rounded-xl z-10 ${
              ...
              <div className={`rounded-2xl p-8 text-center max-w-md mx-4 shadow-xl border ${
                ...
                <div className={`text-left text-sm mb-6 space-y-2 ${isBoxDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  <p>ðŸ§  Watch the color sequence</p>
                  <p>ðŸŽ¯ Repeat it in the same order</p>
                  <p>âœ… Correct: +Points, +Streak</p>
                  <p>âŒ Wrong: -15 Points, reset streak</p>
                  <p>â±ï¸ Timeout: -20 Points</p>
                  <p>ðŸ“ˆ Level up every 3 correct sequences</p>
                  <p>ðŸ† Longer sequences = More points</p>
                </div>
                <button
                  onClick={startGame}
        ...
        {!isFullscreen && (
          <div className={`mt-6 p-4 rounded-lg border ${
            ...
            <ul className={`text-sm space-y-1 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              <li>â€¢ ðŸ§  Watch the sequence of colors carefully</li>
              <li>â€¢ ðŸŽ¯ Click colors in the exact same order</li>
              <li>â€¢ âœ… Complete sequence: +Points (longer = more points)</li>
              <li>â€¢ âŒ Wrong color: -15 Points, sequence resets</li>
              <li>â€¢ â±ï¸ Too slow: -20 Points, sequence resets</li>
              <li>â€¢ ðŸ“ˆ Level up every 3 correct sequences</li>
              <li>â€¢ ðŸ† Streak bonus: +5 points per streak</li>
              <li>â€¢ ðŸ’° Points = (Length Ã— 10) + (Streak Ã— 5) + Speed Bonus</li>
            </ul>
          </div>
        )}
      </div>
