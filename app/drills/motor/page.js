...
export default function MotorDrillsPage() {
  ...
  const categories = [
    { 
      ...
      drills: [
        { name: 'Aim Trainer', folderName: 'aim-trainer', difficulty: 'Hard', duration: '1 min', description: 'Improve your aiming accuracy and speed' },
        { name: 'Click Accuracy', folderName: 'click-accuracy', difficulty: 'Medium', duration: '1 min', description: 'Click on targets as accurately as possible' },
        { name: 'Drag and Drop', folderName: 'drag-and-drop', difficulty: 'Easy', duration: '1 min', description: 'Drag objects to precise locations' }
      ]
    },
    { 
      ...
      drills: [
        { name: 'Rhythm Tap', folderName: 'rhythm-tap', difficulty: 'Medium', duration: '1 min', description: 'Tap in time with the beat' },
        { name: 'Stopwatch Click', folderName: 'stopwatch-click', difficulty: 'Hard', duration: '1 min', description: 'Stop the timer at exactly the right moment' },
        { name: 'Synchronization', folderName: 'synchronization', difficulty: 'Expert', duration: '1 min', description: 'Synchronize your actions with visual cues' }
      ]
    },
    { 
      ...
      drills: [
        { name: 'Steady Hand', folderName: 'steady-hand', difficulty: 'Hard', duration: '1 min', description: 'Navigate a maze without touching the walls' },
        { name: 'Fine Motor', folderName: 'fine-motor', difficulty: 'Medium', duration: '1 min', description: 'Perform precise fine motor movements' },
        { name: 'Tracing', folderName: 'tracing', difficulty: 'Medium', duration: '1 min', description: 'Trace complex shapes accurately' }
      ]
    },
    { 
      name: 'Movement Speed', 
      ...
      drills: [
        { name: 'Rapid Tapping', folderName: 'rapid-tapping', difficulty: 'Easy', duration: '1 min', description: 'Tap as quickly as you can' },
        { name: 'Finger Sequencing', folderName: 'finger-sequencing', difficulty: 'Medium', duration: '1 min', description: 'Press keys in the correct sequence quickly' },
        { name: 'Gesture Speed', folderName: 'gesture-speed', difficulty: 'Medium', duration: '1 min', description: 'Perform gestures as quickly as possible' }
      ]
    }
  ];
