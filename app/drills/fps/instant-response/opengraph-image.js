...
export const alt = 'Instant Response Pro — free browser visual reaction time and trigger discipline aim trainer for CS2 and Valorant';
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

const ACCENT = '#10b981'; // emerald — matches 180-degree-awareness' identity
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            Pure visual reaction training. Click the instant the target flashes — no travel,
            no aim, just latency.
          </div>
        </div>
