              ...
              <div>
                ...
                <div className="mb-5">
                  ...
                  <div className="grid grid-cols-7 gap-1">
                    {[0.5, 1.0, 1.5, 2.0, 3.0, 5.0, 7.0].map((sm) => (
                      <button
                        key={sm}
        ...
        {!isFullscreen && !isMobileLandscape && (
          <footer className="mt-16 border-t border-slate-900 bg-[#05070e]/40 text-slate-550 rounded-2xl py-10 px-6" role="contentinfo">
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-8 mb-8 font-mono text-xs text-left">
                <div>
              ...
              <div className="border-t border-slate-900 pt-8 text-center">
                ...
                <p className="text-[10px] max-w-2xl mx-auto leading-relaxed mb-6 font-sans text-slate-700">
                  ...
                  <button onClick={sharePage} className="text-gray-400 hover:text-white transition-colors p-2.5 bg-gray-900 rounded-full hover:bg-gray-800 shadow-md" title="Share" aria-label="Share page link">
                    <Share2 className="w-5 h-5" />
                  </button>
                  <button onClick={copyPageLink} className="text-gray-400 hover:text-white transition-colors p-2.5 bg-gray-900 rounded-full hover:bg-gray-800 shadow-md" title="Copy link" aria-label="Copy page link to clipboard">
