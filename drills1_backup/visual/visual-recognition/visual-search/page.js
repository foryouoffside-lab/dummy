...
export const metadata = {
  title: "Visual Search - Visual Training & Focus Drill | SkillDrills",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/visual/visual-search',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Visual Search - Visual Training & Focus Drill | SkillDrills",
    description: "Find C among 160 rotated O distractors in a 16x10 grid. Millisecond search time tracking. +1 correct, -1 wrong. 60-second challenge. No sign-up.",
    url: 'https://skilldrills.online/drills/visual/visual-search',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Visual Search - Visual Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function VisualSearchPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Visual Search?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Visual Search drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Visual Search drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Visual Search?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Visual Search drill completely free?</h4>
