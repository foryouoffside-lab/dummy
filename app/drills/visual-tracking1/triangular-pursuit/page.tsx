...
export const metadata = {
  ...
  keywords: ['triangular pursuit', 'visual tracking drill', 'smooth pursuit eye training', 'saccadic eye movement test', 'visual processing speed', 'foveal tracking', 'esports vision training', 'athletic vision drill'],
  openGraph: {
    title: 'Triangular Pursuit - Visual Pursuit & Tracking Drill | SkillDrills',
    description: 'Track target transitions along a visible triangular guide vector. Train visual pursuit tracking and coordinate re-acquisition speeds. No sign-up required.',
    type: 'article',
