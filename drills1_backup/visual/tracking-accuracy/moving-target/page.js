...
export const metadata = {
  title: "Moving Target - Visual Training & Focus Drill | SkillDrills",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/visual/moving-target',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Moving Target - Visual Training & Focus Drill | SkillDrills",
    description: "Train hand-eye coordination with fast-moving targets from all 4 edges. Green cursor feedback on target. 3 lives, streak bonuses. No sign-up.",
    url: 'https://skilldrills.online/drills/visual/moving-target',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Moving Target - Visual Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function KineticInterceptPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Moving Target drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Moving Target?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Moving Target drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Moving Target drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Moving Target?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Moving Target drill completely free?</h4>
