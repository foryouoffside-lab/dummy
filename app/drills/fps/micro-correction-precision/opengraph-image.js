...
export const alt = 'Micro-Correction Aim Trainer — free browser precision aim trainer for CS2 and Valorant';
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

const ACCENT = '#06b6d4'; // cyan — this drill's accent
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            Refine your headshot accuracy with a two-stage flick-then-correct precision drill. Eliminate overflicking and train snap deceleration.
          </div>
        </div>
