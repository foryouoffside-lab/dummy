...
export const alt = 'Aim Trainer Elite — free browser mouse precision and click accuracy aim trainer';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            Improve mouse accuracy, reaction speed, and target acquisition with score-based difficulty scaling.
          </div>
        </div>
