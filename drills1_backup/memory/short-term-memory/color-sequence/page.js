...
export const metadata = {
  title: "Color Sequence - Memory Training & Focus Drill | SkillDrills",
  description: "Train visual memory with 6 vibrant colors and progressive sequences. Play free in your browser with no downloads or registration required.",
  keywords: [
    "color sequence",
    "color sequence training",
    "color sequence game",
    "color sequence test",
    "color sequence online",
    "free color sequence",
    "working memory games",
    "spatial memory training",
    "pattern recall exercise",
    "visual memory grid",
    "short term memory test",
    "recall training online",
    "N-back test memory",
    "sequence memory practice",
    "fluid intelligence game"
],
  alternates: {
    canonical: 'https://skilldrills.online/drills/memory/color-sequence',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Color Sequence - Memory Training & Focus Drill | SkillDrills",
    description: "Train visual memory with 6 vibrant colors and progressive sequences. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/memory/color-sequence',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Color Sequence - Memory Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function ColorSequencePage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Color Sequence?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "This drill is specifically designed to target and improve your memory capabilities, including reaction latency, visual search efficiency, spatial coordination, and fine motor precision."
      }
    },
    {
      "@type": "Question",
      "name": "Is the Color Sequence drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Color Sequence drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Color Sequence?</h4>
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1.5 leading-relaxed">This drill is specifically designed to target and improve your memory capabilities, including reaction latency, visual search efficiency, spatial coordination, and fine motor precision.</p>
            </div>
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Color Sequence drill completely free?</h4>
