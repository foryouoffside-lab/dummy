...
export const SKILL_PILLARS = {
  flickPrecision: {
    ...
    icon: '🎯',
    color: '#ef4444',
    drills: ['pro-flick', 'micro-flick-burst', 'micro-flick-precision', 'headshot-reflex', 'micro-correction'],
  ...
  tracking: {
    ...
    icon: '🔄',
    color: '#3b82f6',
    drills: ['pro-tracking', 'strafe-tracking', 'reactive-sphere', 'pro-smooth-pursuit', 'evasive-slide-track', 'vertical-air-pursuit', 'vertical-air-track', 'anti-strafe', 'anti-zigzag-movement-trainer'],
...
export const DRILL_METADATA = {
  ...
  'micro-correction':       { name: 'Micro-Correction Precision',  path: '/drills/fps/micro-correction-precision' },
  'anti-strafe':            { name: 'Anti-Strafe Jitter Duel',     path: '/drills/fps/anti-strafe-jitter-duel' },
  'anti-zigzag-movement-trainer': { name: 'Anti-Zigzag Movement Trainer', path: '/drills/fps/anti-zigzag-movement-trainer' }
};
