...
export default function SingleLegEquilibriumClient() {
  ...
  const playSound = useCallback((type) => {
    ...
    try {
      ...
      const freqMap = { focus: 880, break: 440, streak: 1046.5, penalty: 330 };
      const gainMap = { focus: 0.08, break: 0.08, streak: 0.1, penalty: 0.12 };
      
      osc.frequency.setValueAtTime(freqMap[type] || 440, now);
      gain.gain.setValueAtTime(gainMap[type] || 0.08, now);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading single leg equilibrium drill...</p>
        </div>
      </div>
    );
  }
    ...
    <div className={`min-h-screen select-none ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "Single Leg Equilibrium",
            "url": "https://skilldrills.online/drills/physical/Balance-Training/single-leg-hold",
            "description": "Balance stability drill where you maintain a link between cursor and bouncing anchor point. Earn +1 point every 2 seconds connected. 60-second challenge with stability and mistake tracking.",
            ...
            "educationalUse": ["Balance Training", "Motor Control", "Hand-Eye Coordination", "Stability Assessment"],
            "learningResourceType": "Interactive Exercise",
            "timeRequired": "PT60S",
            "interactivityType": "active",
            "inLanguage": "en-US",
            "teaches": ["Balance Stability", "Motor Control", "Sustained Attention", "Hand-Eye Coordination"]
          })
        }}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className={`text-sm sm:text-base ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                Keep link connected • +1 per 2 sec on path • -1 per sec off path
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-2 flex-shrink-0">
            {gameState === 'playing' && (
              <button 
                ...
                title="Reset session"
                aria-label="Reset equilibrium drill"
              >
        ...
        <section className="sr-only" aria-label="Drill description for search engines">
          <h2>Single Leg Equilibrium - Balance Stability Training</h2>
          <p>
            Train balance stability and motor control by maintaining a link between your cursor and a bouncing anchor point.
            The anchor moves randomly across the screen with speed regulation.
            Earn +1 point for every 2 seconds of sustained connection (green link).
            Off-path penalty of -1 point per second. Track link stability percentage, streak performance, and total mistakes.
            60-second timed challenge that saves your best score locally.
          </p>
        </section>
        ...
        >
          ...
          <canvas ref={canvasRef} style={{ display: 'block', position: 'absolute', cursor: 'none' }} aria-label="Equilibrium tracking canvas - move mouse to maintain link with anchor point" />
          ...
          {gameState === 'start' && (
            <div className={`absolute inset-0 flex items-center justify-center backdrop-blur-sm rounded-xl z-40 ${isBoxDarkMode ? 'bg-gray-900/95' : 'bg-white/95'}`}>
              <div className={`rounded-2xl p-6 sm:p-8 text-center max-w-md mx-4 shadow-xl border ${isBoxDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                <div className="mb-4">
                  <Move className="w-16 h-16 text-green-500 mx-auto" aria-hidden="true" />
                </div>
                <h2 className={`text-2xl font-bold mb-2 ${isBoxDarkMode ? 'text-white' : 'text-gray-900'}`}>
                  Single Leg Equilibrium
                </h2>
                <p className={`mb-2 ${isBoxDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  +1 per 2 sec on path • -1 per sec off path
                </p>
                <p className={`mb-6 text-sm ${isBoxDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                  Keep the green link connected between your cursor and the bouncing anchor. Green = connected, Red = broken.
                </p>
                <button 
                  onClick={startGame} 
                  ...
                  aria-label="Start single leg equilibrium training"
                >
                  Start Training
                </button>
              </div>
            ...
            <div className={`absolute inset-0 flex items-center justify-center backdrop-blur-sm rounded-xl z-40 ${isBoxDarkMode ? 'bg-gray-900/95' : 'bg-white/95'}`}>
              <div className={`rounded-2xl p-6 sm:p-8 shadow-xl border w-full max-w-[520px] mx-4 ${isBoxDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                ...
                <p className={`text-center text-sm mb-6 ${isBoxDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                  Regular equilibrium training improves motor control and sustained attention.
                </p>
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                  ...
                  <ResultCard label="Link Stability" value={linkStability} unit="%" icon={<LinkIcon className="w-4 h-4" />} color="emerald" isDark={isBoxDarkMode} />
                  <ResultCard label="Mistakes" value={mistakes} icon={<Activity className="w-4 h-4" />} color="red" isDark={isBoxDarkMode} />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Keep the <span className="font-semibold text-green-500">green link connected</span> between cursor and anchor</p>
                    </div>
                    <div className="flex items-start gap-2">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Every <span className="font-semibold text-orange-500">100 streak</span> triggers bonus notification</p>
                    </div>
                    <div className="flex items-start gap-2">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Green link = connected • <span className="font-semibold text-yellow-500">Red dashed = broken</span></p>
                    </div>
                  </div>
                </div>
                <div className={`mt-4 pt-3 border-t flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 text-xs ${isDarkMode ? 'border-gray-700 text-gray-400' : 'border-gray-200 text-gray-500'}`}>
                  <span>🔗 Link Stability = % of frames connected | Higher is better</span>
