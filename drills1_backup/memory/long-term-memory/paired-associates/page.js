...
export const metadata = {
  ...
  keywords: [
    ...
    "paired associates game",
    "paired associates test",
    "paired associates online",
    "free paired associates",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/memory/paired-associates',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Paired Associates - Word Pair Memory | SkillDrills",
    description: "Train paired associate memory with 80 unique word pairs across 5 difficulty tiers. Memorize pairs, then pick the correct match from 3 options. Adaptive rounds. No sign-up.",
    url: 'https://skilldrills.online/drills/memory/paired-associates',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Paired Associates - Word Pair Memory | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function PairedAssociatesPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Paired Associates?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Paired Associates drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Paired Associates drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Paired Associates?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Paired Associates drill completely free?</h4>
