...
export const metadata = {
  title: "Entropic Grid - Visual Training & Focus Drill | SkillDrills",
  ...
  keywords: [
    "entropic grid",
    "entropic grid training",
    "entropic grid game",
    "entropic grid test",
    "entropic grid online",
    "free entropic grid",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/visual/entropic-grid',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Entropic Grid - Visual Training & Focus Drill | SkillDrills",
    description: "Find 2-char targets in 100-cell grid while entropy corrupts 3 cells every 800ms. Stamina system with decay. Target refreshes. No sign-up.",
    url: 'https://skilldrills.online/drills/visual/entropic-grid',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Entropic Grid - Visual Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function EntropicGridPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Entropic Grid?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Entropic Grid drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Entropic Grid drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Entropic Grid?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Entropic Grid drill completely free?</h4>
