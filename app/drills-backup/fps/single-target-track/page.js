...
import { 
  ...
  Sun, Moon, Eye, Timer, Trophy, MousePointer, Zap, Activity, Award, Info
} from 'lucide-react';
...
export default function SmoothTrackingPage() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      if (isTracked) {
        // 1 second of tracking = +5 points
        trackingTimeRef.current += 0.2;
        totalTrackTimeRef.current += 0.2;
    ...
    <div className={`min-h-screen select-none ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>Keep cursor on target â€¢ Build tracking endurance</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-6 gap-3 mb-4 h-[88px]">
          ...
          <StatCard icon={<Trophy className="text-yellow-500" />} value={bestTrackingScore} label="Best Score" isDark={isDarkMode} />
          ...
          <StatCard icon={<Timer className="text-cyan-500" />} value={totalTrackTime.toFixed(1)} label="Total Time" unit="s" isDark={isDarkMode} />
        </div>
          ...
          {gameState === 'start' && (
            <div className={`absolute inset-0 flex items-center justify-center backdrop-blur-sm rounded-xl z-40 ${isBoxDarkMode ? 'bg-gray-900/95' : 'bg-white/95'}`}>
              <div className={`rounded-2xl p-8 text-center max-w-md mx-4 shadow-xl border ${isBoxDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                ...
                <p className={`mb-6 ${isBoxDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>60-second challenge â€¢ 1 sec tracking = +5 pts</p>
                <button 
                  onClick={startGame} 
            ...
            <div className={`absolute inset-0 flex items-center justify-center backdrop-blur-sm rounded-xl z-40 ${isBoxDarkMode ? 'bg-gray-900/95' : 'bg-white/95'}`}>
              <div className={`rounded-2xl p-8 shadow-xl border w-[480px] ${isBoxDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  ...
                  <ResultCard label="Total Track Time" value={totalTrackTime.toFixed(1)} unit="s" icon={<Timer className="w-4 h-4" />} color="text-cyan-500" />
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        <span className="font-semibold text-green-500">Keep cursor on the green target</span> â€¢ Glows when tracked
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        <span className="font-semibold text-blue-500">1 second of tracking = +5 points</span> â€¢ Build your score
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        <span className="font-semibold text-purple-500">Track Streak = Consecutive tracking time</span> â€¢ 25 streak bonus
                      </p>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        <span className="font-semibold text-cyan-500">Accuracy = Cursor proximity to target</span> â€¢ Higher is better
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        <span className="font-semibold text-orange-500">Arrow shows movement direction</span> â€¢ When off-target
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
