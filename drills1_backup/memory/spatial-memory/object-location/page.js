...
export const metadata = {
  ...
  description: "Train spatial memory with 10 emoji objects on expanding 3x3 to 7x7 grids. Play free in your browser with no downloads or registration required.",
  keywords: [
    "object location",
    "object location training",
    "object location game",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/memory/object-location',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Object Location - Position Memory | SkillDrills",
    description: "Train spatial memory with 10 emoji objects on expanding 3x3 to 7x7 grids. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/memory/object-location',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Object Location - Position Memory | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function ObjectLocationPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Object Location?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Object Location drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Object Location drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Object Location?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Object Location drill completely free?</h4>
