...
// Obstacle class (outside component)
class Obstacle {
  constructor(cvs, mouse, speed) {
...
export default function QuickDodgeClient() {
  ...
  const playSound = useCallback((type) => {
    ...
    try {
      ...
      const freqMap = { dodge: 880, hit: 440, streak: 1046.5, highscore: 1318.52 };
      
      osc.frequency.setValueAtTime(freqMap[type] || 880, now);
      gain.gain.setValueAtTime(type === 'highscore' ? 0.12 : type === 'hit' ? 0.1 : 0.08, now);
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      if (spawnTimerRef.current > spawnRate && isActiveRef.current && obstaclesRef.current.length < maxObstacles) {
        obstaclesRef.current.push(new Obstacle(cvs, mouse, speedRef.current));
  ...
  }, [gameState, isBoxDarkMode, addPenalty, playSound, showFeedback, bestScore]);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading quick dodge drill...</p>
        </div>
      </div>
    );
  }
    ...
    <div className={`min-h-screen select-none ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "Quick Dodge Elite",
            "url": "https://skilldrills.online/drills/physical/Reflex-Training/quick-dodge",
            "description": "Dodge red homing obstacles tracking your cursor. +1 per dodge, -5 on hit. Adaptive speed with streaks. Fullscreen mode for 50% more challenge. 60-second evasion reflex training.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className={`text-sm sm:text-base ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                Avoid red homing obstacles • +1 per dodge • -5 on hit • 60s
              </p>
            </div>
          </div>
        ...
        <section className="sr-only" aria-label="Drill description for search engines">
          <h2>Quick Dodge Elite - Evasion Reflex & Spatial Awareness Training</h2>
          <p>
            Train evasion reflexes by dodging red homing obstacles that track your cursor position.
            Obstacles spawn from random screen edges and grow as they approach.
            Each successful dodge earns +1 point. Hitting an obstacle costs -5 points and resets your streak.
            Speed adaptively increases every 3 dodges (300-700 px/s).
            Fullscreen mode increases obstacle spawn rate by 50% and raises max obstacles from 15 to 25 for extra challenge.
        ...
        >
          ...
          <canvas ref={canvasRef} style={{ display: 'block', position: 'absolute' }} aria-label="Quick dodge canvas - move cursor to avoid red homing obstacles" />
            ...
            <div className={`absolute inset-0 flex items-center justify-center backdrop-blur-sm rounded-xl z-40 ${isBoxDarkMode ? 'bg-gray-900/95' : 'bg-white/95'}`}>
              <div className={`rounded-2xl p-6 sm:p-8 text-center max-w-md mx-4 shadow-xl border ${isBoxDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                ...
                <p className={`mb-6 text-sm ${isBoxDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                  +1 per dodge, -5 on hit. Fullscreen = 50% more obstacles!
                </p>
                <button 
                  onClick={startGame} 
                  ...
                  aria-label="Start quick dodge training"
                >
                  Start Training
                </button>
              </div>
            ...
            <div className={`absolute inset-0 flex items-center justify-center backdrop-blur-sm rounded-xl z-40 ${isBoxDarkMode ? 'bg-gray-900/95' : 'bg-white/95'}`}>
              <div className={`rounded-2xl p-6 sm:p-8 shadow-xl border w-full max-w-[520px] mx-4 ${isBoxDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                ...
                <p className={`text-center text-sm mb-6 ${isBoxDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                  Regular dodge training improves spatial awareness and evasion reflexes.
                </p>
            ...
            <div className={`rounded-xl border overflow-hidden ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
              ...
              <div className="p-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    <div className="flex items-start gap-2">
                      <div className="w-5 h-5 rounded-full bg-red-500 flex items-center justify-center text-white text-xs font-bold flex-shrink-0 mt-0.5">1</div>
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Move cursor to <span className="font-semibold text-red-500">avoid red obstacles</span> that home in</p>
                    </div>
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Dodge: <span className="font-semibold text-green-500">+1 point</span></p>
                    </div>
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Hit: <span className="font-semibold text-orange-500">-5 points & streak reset</span></p>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Every 3 dodges = <span className="font-semibold text-purple-500">speed increase</span> (300→700 px/s)</p>
                    </div>
                    <div className="flex items-start gap-2">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        Fullscreen = <span className="font-semibold text-yellow-500">50% more obstacles</span> (15→25 max)
                      </p>
                    </div>
                  </div>
                </div>
                <div className={`mt-4 pt-3 border-t flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 text-xs ${isDarkMode ? 'border-gray-700 text-gray-400' : 'border-gray-200 text-gray-500'}`}>
                  ...
                  <span>⚡ Fullscreen mode = More chaos = More dodging practice!</span>
                </div>
              </div>
            </div>
          </footer>
