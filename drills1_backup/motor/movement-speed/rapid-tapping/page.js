...
export const metadata = {
  ...
  keywords: [
    "rapid tapping",
    "rapid tapping training",
    "rapid tapping game",
    "rapid tapping test",
    "rapid tapping online",
    "free rapid tapping",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/motor/rapid-tapping',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Click Speed Test - Free Rapid Tapping & CPS Test | SkillDrills",
    description: "Free click speed test online. Tap rapidly to keep a shrinking ball alive — the best CPS test and click endurance drill. Difficulty scales every 3 seconds. No sign-up required.",
    url: 'https://skilldrills.online/drills/motor/rapid-tapping',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Click Speed Test - Free Rapid Tapping & CPS Test | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function RapidTappingPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Rapid Tapping?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Rapid Tapping drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Rapid Tapping drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Rapid Tapping?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Rapid Tapping drill completely free?</h4>
