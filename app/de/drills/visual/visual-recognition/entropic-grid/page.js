...
const guideData = {
  ...
  intro: [
    ...
    "Im Guided-Search-Modell 4.0 von Jeremy Wolfe (Wolfe, 2007) interagieren stimulusgetriebene Bottom-Up-Auffälligkeiten mit zielorientierten Top-Down-Vorgaben, um im Gehirn eine sogenannte 'Prioritätskarte' (Priority Map) aufzubauen. Im Entropic-Grid-Szenario erzeugen 100 Zellen mit zyklisch wechselndem Rauschen eine extrem hohe visuelle Entropie, die das Bottom-Up-System massiv überflutet. Um hier erfolgreich zu agieren, müssen der dorsolaterale präfrontale Kortex und parietale Netzwerke starke inhibitorische Signale aussenden, die irrelevante Rauschreize aktiv tilgen (Duncan & Humphreys, 1989).",
    "Die physikalische Grenze der visuellen Suchgeschwindigkeit wird primär durch die Fixationsdauer der Augen (ca. 200 bis 250 Millisekunden) und die Sakkadenlatenz bestimmt (Posner, 1980; Woods et al., 2015). Wer das Raster Zelle für Zelle streng seriell abliest, schafft in 45 Sekunden nur wenige Treffer. Professionelle E-Sportler und trainierte Beobachter erweitern stattdessen ihr Aufmerksamkeitsfenster und tasten mit einer einzigen Fixation 4 bis 9 Zellen simultan ab (Green & Bavelier, 2006).",
    "Dieses standardisierte Web-Trainingsmodul erfasst anhand hochpräziser Timer-Laufzeiten die individuelle Suchlatenz, Trefferfrequenz und Fehlerquoten. Ein regelmäßiges Training im dynamischen Entropic Grid schärft die sensorische Filterkapazität unter extremem visuellem Clutter – ein unschätzbarer Vorteil für taktische Shooter, das Erkennen von Gefahren im Straßenverkehr oder das rasche Erfassen komplexer Datenstrukturen im Berufsalltag."
  ],
  benchmarks: {
