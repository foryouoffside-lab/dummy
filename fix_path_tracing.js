const fs = require('fs');
const file = 'C:/Users/sangmesh/Desktop/global-drill-system-nextjs - Copy/app/drills/memory/spatial-memory/path-tracing/PathTracingClient.js';
...
if (startIdx !== -1 && endFooterIdx !== -1) {
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                <p className="text-sm text-gray-400 leading-relaxed mb-6">
                  This cognitive drill trains sequential spatial memory and route encoding. By watching an animated dot path and retracing it in the exact order, you are strengthening your brain's ability to hold complex, ordered spatial maps in short-term memory—a critical skill for navigation, procedural tasks, and tactical execution.
                </p>
                ...
                <div className="mb-6 p-5 rounded-xl border border-gray-800 bg-black/40">
                  ...
                  <ul className="space-y-3 text-sm text-gray-400">
                    <li><strong className="text-amber-400">Observe:</strong> Animated Path | 0.5s per Dot</li>
                    <li><strong className="text-purple-400">Adaptive Grid Sizing:</strong> 3x3 -> 7x7 | Expands per Level</li>
                    <li><strong className="text-green-400">Perfect Route:</strong> +5 PTS | +5s Time</li>
              ...
              <div>
                <div className="p-5 rounded-xl border border-gray-800 bg-black/40 mb-6">
                  ...
                  <ol className="space-y-3 list-decimal pl-5 text-sm text-gray-400">
                    <li><strong className="text-white">Encode:</strong> Watch carefully as the path illuminates node by node.</li>
                    <li><strong className="text-white">Recall:</strong> Click the nodes in the exact same sequence as the path you just saw.</li>
                ...
                <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-1">Athletes needing strong field awareness, drivers, pilots, gamers, and anyone wanting to improve sequential spatial navigation.</p>
                    </div>
                    <div>
                      <h4 className="text-sm font-bold text-gray-200">What skills are improved?</h4>
                      <p className="text-xs text-gray-400 mt-1">Sequential spatial working memory, route tracking, ordered spatial layout recognition, and concentration under time pressure.</p>
                    </div>
                  </div>
                </div>
              </div>
  ...
  return (
    ...
    console.log('Fixed PathTracingClient.js successfully.');
} else {
