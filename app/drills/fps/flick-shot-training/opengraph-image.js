...
export const alt = 'Pro Flick Trainer — free browser macro flicking and aim precision trainer for CS2 and Valorant';
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

const ACCENT = '#10b981'; // emerald — pro flick trainer accent
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            Snap your crosshair to targets anywhere on screen. Train ballistic flick speed
            and stopping precision.
          </div>
        </div>
