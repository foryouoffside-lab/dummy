...
export const alt = 'Anti-Zigzag Movement Trainer — free browser reactive strafe tracking aim trainer';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            Master reactive tracking against erratic zigzag movement, slide cancels, and desync strafing in FPS games.
          </div>
        </div>
