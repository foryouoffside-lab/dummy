...
export const metadata = {
  title: "Sine Wave Pursuit - Visual Pursuit & Tracking Drill | SkillDrills",
  description: "Track target oscillations along a horizontal sine wave guide line. Train visual pursuit tracking and coordinate re-acquisition speeds. No sign-up required.",
  keywords: [
    "sine wave pursuit",
    "sine wave pursuit training",
    "sine wave pursuit game",
    "sine wave pursuit test",
    "sine wave pursuit online",
    "free sine wave pursuit",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Sine Wave Pursuit - Visual Pursuit & Tracking Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function SineWavePursuitPage() {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Sine-Wave Pursuit" }
            ]
          })
        }}
      />
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Sine Wave Pursuit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Sine Wave Pursuit drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Sine Wave Pursuit drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Sine Wave Pursuit?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Sine Wave Pursuit drill completely free?</h4>
