...
export const alt = 'Target Acquisition Pro — free browser target selection aim trainer for CS2 and Valorant';
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

const ACCENT = '#f59e0b'; // amber — target acquisition accent
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            Find and eliminate the correct target among decoys. Train visual discrimination
            and threat selection under pressure.
          </div>
        </div>
