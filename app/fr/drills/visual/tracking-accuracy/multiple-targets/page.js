...
const multipleTargetsGuide = {
  ...
  intro: "Le paradigme de Poursuite d'Objets Multiples (MOT - Multiple Object Tracking), développé par Zenon Pylyshyn (1988), constitue la référence scientifique absolue pour mesurer l'attention visuelle divisée et la mémoire de travail spatio-temporelle. Contrairement à la poursuite visuelle continue d'une cible unique, le test MOT sollicite le cortex pariétal postérieur pour assigner et maintenir des index visuels indépendants (FINSTs) sur plusieurs entités en mouvement chaotique parmi une multitude de distracteurs rigoureusement identiques. Les sportifs de haut niveau dans les disciplines collectives (football, rugby, basket-ball), les pilotes de chasse et les joueurs professionnels d'esport s'appuient sur cette faculté pour maintenir une conscience situationnelle (situational awareness) sans faille sous forte charge mentale.",
  benchmarks: {
