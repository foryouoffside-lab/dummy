...
const drillRoutes = [
  ...
  // ==================== FPS DRILLS (21) - Highest Priority ====================
  { path: '/drills/fps/180-degree-awareness', category: 'FPS Training', priority: 1.0 },
  { path: '/drills/fps/240fps-click-test', category: 'FPS Training', priority: 1.0 },
  { path: '/drills/fps/360fps-reflex', category: 'FPS Training', priority: 1.0 },
  { path: '/drills/fps/chaos-tracking', category: 'FPS Training', priority: 1.0 },
  { path: '/drills/fps/clinical-gray-grid', category: 'FPS Training', priority: 1.0 },
  { path: '/drills/fps/flick-shot-240fps', category: 'FPS Training', priority: 1.0 },
  { path: '/drills/fps/flick-shot-training', category: 'FPS Training', priority: 1.0 },
  { path: '/drills/fps/flick-training', category: 'FPS Training', priority: 1.0 },
  ...
  { path: '/drills/fps/map-prediction', category: 'FPS Training', priority: 1.0 },
  { path: '/drills/fps/multi-target-tracking', category: 'FPS Training', priority: 1.0 },
  { path: '/drills/fps/neural-tracker', category: 'FPS Training', priority: 1.0 },
  { path: '/drills/fps/orbital-tracking-drill', category: 'FPS Training', priority: 1.0 },
  { path: '/drills/fps/peripheral-awareness', category: 'FPS Training', priority: 1.0 },
  { path: '/drills/fps/predictive-tracking', category: 'FPS Training', priority: 1.0 },
  ...
  { path: '/drills/fps/reactive-tracking', category: 'FPS Training', priority: 1.0 },
  { path: '/drills/fps/single-target-track', category: 'FPS Training', priority: 1.0 },
