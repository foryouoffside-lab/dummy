...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/academic/typing-test',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Typing Speed Test - WPM & Accuracy | SkillDrills",
    description: "Test typing speed with 30 quotes across Easy, Medium, and Hard levels. Real-time WPM, accuracy, and combo streaks. 60-second challenge. No sign-up.",
    url: 'https://skilldrills.online/drills/academic/typing-test',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Typing Speed Test - WPM & Accuracy | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function TypingTestPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Typing Test drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Typing Test?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Typing Test drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Typing Test drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Typing Test?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Typing Test drill completely free?</h4>
