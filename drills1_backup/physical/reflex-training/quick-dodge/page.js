...
export const metadata = {
  ...
  description: "Free dodge game online. Play free in your browser with no downloads or registration required.",
  keywords: [
    "quick dodge",
    "quick dodge training",
    "quick dodge game",
    "quick dodge test",
    "quick dodge online",
    "free quick dodge",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/physical/quick-dodge',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Dodge Game Online - Free Reflex Evasion Training | SkillDrills",
    description: "Free dodge game online. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/physical/quick-dodge',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Dodge Game Online - Free Reflex Evasion Training | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function QuickDodgePage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Quick Dodge drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Quick Dodge?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Quick Dodge drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Quick Dodge drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Quick Dodge?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Quick Dodge drill completely free?</h4>
