...
export const alt = 'Attention Span Test — free online concentration stamina and attention endurance drill';
      ...
      >
        ...
        <div
          style={{
            ...
            height: 620,
            borderRadius: 9999,
            background: 'radial-gradient(circle, rgba(168,85,247,0.22) 0%, rgba(5,5,8,0) 70%)',
            display: 'flex',
          }}
        />
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          {['45-SECOND DRILL', '15 DIFFICULTY LEVELS', 'SUSTAINED VIGILANCE', 'FREE — NO SIGN-UP'].map((label) => (
            <div
              key={label}
              style={{
                display: 'flex',
