...
//    Where a page's target term has measured Bing volume (see docs/SEO_PROGRESS.md
...
export const DRILL_TAGLINES = {
  ...
  // ---------------- MOTOR ----------------
  '/drills/motor/keyboard-tester': 'Check every key on your keyboard for dead keys, stuck keys and rollover limits',
  ...
  '/drills/reaction-speed/reaction-game': 'Catch falling targets in their lane',
