...
const multipleTargetsGuide = {
  ...
  intro: "El paradigma de Seguimiento de Múltiples Objetos (MOT - Multiple Object Tracking), propuesto originalmente por Zenon Pylyshyn (1988), es el estándar de referencia en la ciencia cognitiva para evaluar la atención visual dividida y el seguimiento dinámico espacial. A diferencia del seguimiento de un único objetivo mediante movimientos sacádicos o de persecución suave, el MOT exige que el lóbulo parietal asigne y mantenga múltiples punteros espaciales independientes (FINSTs) sobre blancos que se mueven caóticamente entre distractores idénticos. Pilotos de combate, atletas de élite en deportes colectivos (fútbol, baloncesto) y jugadores competitivos de eSports dependen de esta capacidad para mantener una percepción situacional impecable en situaciones de estrés visual.",
  benchmarks: {
