...
export const metadata = {
  title: "Saccadic Gallery - Interactive Reflex & Reaction Speed Drill | SkillDrills",
  description: "Sequence-based ballistic eye shifts. Play free in your browser with no downloads or registration required.",
  keywords: [
    "saccadic gallery",
    "saccadic gallery training",
    "saccadic gallery game",
    "saccadic gallery test",
    "saccadic gallery online",
    "free saccadic gallery",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Saccadic Gallery - Interactive Reflex & Reaction Speed Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function SaccadicGalleryPage() {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Saccadic Gallery" }
            ]
          })
        }}
      />
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Saccadic Gallery?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Saccadic Gallery drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Saccadic Gallery drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Saccadic Gallery?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Saccadic Gallery drill completely free?</h4>
