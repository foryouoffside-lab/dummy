...
export const alt = 'Dynamic Evasion Pursuit — Reactive Eye Tracking Drill | SkillDrills';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            {"Train reactive visual pursuit against sudden evasive directional turns."}
          </div>
        </div>
