...
export const alt = 'Drag & Drop Precision Trainer — free browser mouse spatial control and deceleration aim trainer';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            Master mouse spatial dragging control, cursor deceleration speed, and release timing.
          </div>
        </div>
