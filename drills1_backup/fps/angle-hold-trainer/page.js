...
export const metadata = {
  ...
  description: "Free crosshair placement training online. Play free in your browser with no downloads or registration required.",
  keywords: [
    "angle hold trainer",
    "angle hold trainer training",
    "angle hold trainer game",
    "angle hold trainer test",
    "angle hold trainer online",
    "free angle hold trainer",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Crosshair Placement Training - Free Angle Hold & Peek Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function AngleHoldPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Angle Hold Trainer drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Angle Hold Trainer?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Angle Hold Trainer drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Angle Hold Trainer drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Angle Hold Trainer?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Angle Hold Trainer drill completely free?</h4>
