    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: 'Free Word Recall Memory Drill | SkillDrills',
          text: 'Train verbal short-term memory by recalling word lists. Free!',
          url: 'https://skilldrills.online/drills/memory/short-term-memory/word-recall'
        });
      } catch (e) {}
    } else {
      navigator.clipboard.writeText('https://skilldrills.online/drills/memory/short-term-memory/word-recall');
      alert('Link copied!');
    }
  };
  ...
  return (
    <div className={`min-h-screen select-none ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "Word Recall Drill - Verbal Short-Term Memory & Free Recall Training",
            "url": "https://skilldrills.online/drills/memory/short-term-memory/word-recall",
            "description": "Free verbal short-term memory drill featuring 50 unique words with progressive difficulty starting at 3 words. 10-second memorization phase with skip option then free recall typing. +1 per correct word with penalty equal to word count on mistakes. Green and red feedback shows recalled vs missed words. Perfect recall advances to next level with +1 word. 60-second timed challenge with streak tracking.",
            "applicationCategory": "EducationalApplication",
            "operatingSystem": "All",
            "offers": { "@type": "Offer", "price": "0", "priceCurrency": "USD", "availability": "https://schema.org/OnlineOnly" },
            "author": { "@type": "Organization", "name": "SkillDrills", "url": "https://skilldrills.online" },
            "publisher": { "@type": "Organization", "name": "SkillDrills" },
            "educationalUse": ["Verbal Memory Training", "Short-Term Memory", "Free Recall Practice", "Word List Learning", "Cognitive Training"],
            "learningResourceType": ["Interactive Exercise", "Memory Drill", "Verbal Training"],
            "timeRequired": "PT60S",
            "interactivityType": "active",
            "inLanguage": "en-US",
            "teaches": ["Word Recall", "Verbal Short-Term Memory", "Free Recall", "List Learning", "Verbal Working Memory"],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={`text-sm sm:text-base ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                  Free verbal short-term memory drill • +1 per word • Penalty = word count • 60s
                </p>
              </div>
            </div>
        ...
        {!isFullscreen && (
          <section className="mt-8" aria-label="About this word recall drill">
            <div className={`rounded-xl border overflow-hidden ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
              <div className={`px-4 py-3 border-b ${isDarkMode ? 'border-gray-700 bg-gray-800/50' : 'border-gray-200 bg-gray-50'}`}>
                <div className="flex items-center gap-2">
                  <GraduationCap className={`w-5 h-5 ${isDarkMode ? 'text-pink-400' : 'text-pink-600'}`} aria-hidden="true" />
                  <h2 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>About This Free Word Recall Drill</h2>
                </div>
              </div>
              <div className="p-5">
                <p className={`text-sm leading-relaxed mb-5 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  This free word recall drill trains verbal short-term memory using the free recall paradigm where you memorize word lists and type everything you remember without cues. With 50 unique words spanning concrete nouns and abstract concepts, each round presents a randomized list starting at 3 words with progressive difficulty. The 10-second memorization phase with skip option lets you control your study time. After recall, green and red visual feedback instantly shows which words you remembered and which you missed. Perfect recall advances you to the next level with one additional word, while any mistake applies a penalty equal to the word count and restarts the same level. Perfect for students strengthening vocabulary retention, language learners building word memory, and anyone wanting to improve verbal working memory and list learning ability.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-5">
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-pink-50 border-pink-100'}`}>
                    ...
                    <p className={`text-xs leading-relaxed ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                      Students strengthening vocabulary retention, language learners building word memory, professionals improving verbal recall, seniors maintaining verbal cognitive function, and anyone wanting better list learning and free recall abilities.
                    </p>
                  </div>
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-green-50 border-green-100'}`}>
                    ...
                    <p className={`text-xs leading-relaxed ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                      Verbal short-term memory, free recall ability, word list learning, verbal working memory, vocabulary retention, and the ability to encode and retrieve verbal information without recognition cues.
                    </p>
                  </div>
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-purple-50 border-purple-100'}`}>
                    ...
                    <p className={`text-xs leading-relaxed ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                      Score, accuracy percentage, streak of perfect rounds, rounds completed, mistake count, green/red word feedback, and best performance records saved locally.
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-yellow-50 border-yellow-100'}`}>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className={`text-sm font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Why Practice Word Recall?</h3>
                    </div>
                    <ul className={`text-xs space-y-2 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                      <li className="flex items-start gap-2">
                        ...
                        Free recall mimics real-world memory demands better than recognition tests
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-3 h-3 text-yellow-500 mt-0.5 flex-shrink-0" />
                        Builds verbal encoding strategies transferable to academic and professional learning
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-3 h-3 text-yellow-500 mt-0.5 flex-shrink-0" />
                        Progressive word count ensures continuous challenge as memory improves
                      </li>
                    </ul>
                  </div>
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-orange-50 border-orange-100'}`}>
                    ...
                    <ol className={`text-xs space-y-2 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                      <li className="flex items-start gap-2">
                        ...
                        Create mental images or stories linking the words together
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        Use the full 10 seconds before skipping for better retention
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        Review missed words shown in red to learn from mistakes
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        Practice 10-15 minutes daily for best verbal memory improvement
                      </li>
                    </ol>
                  </div>
                </div>
        ...
        {!isFullscreen && (
          <section className="mt-8" aria-label="Related memory and cognitive drills">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-1 h-6 rounded-full bg-gradient-to-b from-pink-500 to-purple-600"></div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <Link href="/drills/memory/short-term-memory/digit-span" className={`group relative overflow-hidden rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${isDarkMode ? 'bg-gray-800 border-gray-700 hover:border-blue-500' : 'bg-white border-gray-200 hover:border-blue-300'}`}>
                ...
                <div className="p-4">
                  ...
                  <h3 className={`font-semibold text-sm mb-1 ${isDarkMode ? 'text-white group-hover:text-blue-400' : 'text-gray-900 group-hover:text-blue-600'} transition-colors`}>Digit Span</h3>
              ...
              <Link href="/drills/memory/long-term-memory/paired-associates" className={`group relative overflow-hidden rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${isDarkMode ? 'bg-gray-800 border-gray-700 hover:border-cyan-500' : 'bg-white border-gray-200 hover:border-cyan-300'}`}>
                ...
                <div className="p-4">
                  ...
                  <p className={`text-xs leading-relaxed ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>Memorize word pairs then select the correct match from 3 options.</p>
              ...
              <Link href="/drills/memory/long-term-memory/image-association" className={`group relative overflow-hidden rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${isDarkMode ? 'bg-gray-800 border-gray-700 hover:border-red-500' : 'bg-white border-gray-200 hover:border-red-300'}`}>
                ...
                <div className="p-4">
                  ...
                  <h3 className={`font-semibold text-sm mb-1 ${isDarkMode ? 'text-white group-hover:text-red-400' : 'text-gray-900 group-hover:text-red-600'} transition-colors`}>Image Association</h3>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8 mb-8">
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    <li><Link href="/drills/memory/short-term-memory/word-recall" className="hover:text-white transition-colors">Word Recall</Link></li>
              ...
              <div className="border-t border-gray-800 pt-8 text-center">
                ...
                <p className="text-xs max-w-2xl mx-auto leading-relaxed mb-6">
                  Free online word recall drill for verbal short-term memory training. 50 unique words with progressive difficulty starting at 3 words. 10-second memorization with skip option and free recall typing. Green and red feedback shows recalled vs missed words. Perfect for students language learners and anyone wanting to improve verbal memory. No registration required. More free memory drills at skilldrills.online.
                </p>
                <div className="flex items-center justify-center gap-5 flex-wrap">
                  <button onClick={sharePage} className="text-gray-500 hover:text-white transition-colors" title="Share this drill" aria-label="Share this free word recall drill">
