...
export const metadata = {
  title: "Divided Attention | SkillDrills",
  description: "Train Divided Attention skills online with this free interactive drill. Play free in your browser with no downloads or registration required.",
  keywords: [
    "divided attention",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/cognitive/divided-attention',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Divided Attention | SkillDrills",
    description: "Train Divided Attention skills online with this free interactive drill. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/cognitive/divided-attention',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Divided Attention | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function DividedAttentionPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Divided Attention?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Divided Attention drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Divided Attention drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Divided Attention?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Divided Attention drill completely free?</h4>
