    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: 'Free Object Location Memory Drill | SkillDrills',
          text: 'Train spatial position memory with emoji objects on expanding grids. Free!',
          url: 'https://skilldrills.online/drills/memory/spatial-memory/object-location'
        });
      } catch (e) {}
    } else {
      navigator.clipboard.writeText('https://skilldrills.online/drills/memory/spatial-memory/object-location');
      alert('Link copied!');
    }
  };
  ...
  return (
    <div className={`min-h-screen select-none ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "Object Location Drill - Spatial Position Memory & Visual-Spatial Training",
            "url": "https://skilldrills.online/drills/memory/spatial-memory/object-location",
            "description": "Free spatial position memory drill featuring 10 unique emoji objects on expanding grids from 3×3 to 7×7. 3-4 second memorization phase then locate where the target object was placed. +1 for correct location -1 for wrong. Auto-advancing rounds with level progression. 60-second timed challenge with streak tracking.",
            "applicationCategory": "EducationalApplication",
            "operatingSystem": "All",
            "offers": { "@type": "Offer", "price": "0", "priceCurrency": "USD", "availability": "https://schema.org/OnlineOnly" },
            "author": { "@type": "Organization", "name": "SkillDrills", "url": "https://skilldrills.online" },
            "publisher": { "@type": "Organization", "name": "SkillDrills" },
            "educationalUse": ["Spatial Memory Training", "Position Recall", "Visual-Spatial Practice", "Object Location Memory", "Cognitive Training"],
            "learningResourceType": ["Interactive Exercise", "Memory Drill", "Spatial Training"],
            "timeRequired": "PT60S",
            "interactivityType": "active",
            "inLanguage": "en-US",
            "teaches": ["Spatial Position Memory", "Object Location Recall", "Visual-Spatial Memory", "Grid-Based Memory", "Positional Working Memory"],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={`text-sm sm:text-base ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                  Free spatial position memory drill • +1/-1 scoring • Expanding grid • 60s
                </p>
              </div>
            </div>
        ...
        {!isFullscreen && (
          <section className="mt-8" aria-label="About this object location drill">
            <div className={`rounded-xl border overflow-hidden ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
              <div className={`px-4 py-3 border-b ${isDarkMode ? 'border-gray-700 bg-gray-800/50' : 'border-gray-200 bg-gray-50'}`}>
                <div className="flex items-center gap-2">
                  <GraduationCap className={`w-5 h-5 ${isDarkMode ? 'text-emerald-400' : 'text-emerald-600'}`} aria-hidden="true" />
                  <h2 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>About This Free Object Location Drill</h2>
                </div>
              </div>
              <div className="p-5">
                <p className={`text-sm leading-relaxed mb-5 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  This free object location drill trains spatial position memory by challenging you to remember where multiple emoji objects are placed on a grid. With 10 unique emoji objects (🌟💎🔑🎯🔥⭐💡🎵🌺🦋), each round places objects in random positions on a grid that expands from 3×3 up to 7×7 as you progress. You have 3-4 seconds to memorize all positions, then must find where a specific target object was located on an empty grid. The progressive difficulty system adds more objects and expands the grid size automatically as you answer correctly. Perfect for students developing visual-spatial skills, professionals strengthening positional memory, and anyone wanting to improve their ability to remember where things are located.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-5">
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-emerald-50 border-emerald-100'}`}>
                    ...
                    <p className={`text-xs leading-relaxed ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                      Students developing visual-spatial skills, professionals strengthening positional memory, designers organizing layouts mentally, and anyone wanting to improve their ability to remember where objects are placed in space.
                    </p>
                  </div>
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-green-50 border-green-100'}`}>
                    ...
                    <p className={`text-xs leading-relaxed ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                      Spatial position memory, object location recall, visual-spatial working memory, grid-based memory encoding, and the ability to remember positions of multiple items simultaneously.
                    </p>
                  </div>
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-purple-50 border-purple-100'}`}>
                    ...
                    <p className={`text-xs leading-relaxed ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                      Score, level progression, streak count, grid size expansion, best performance records saved locally, and real-time feedback with green highlight showing correct location after each answer.
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-yellow-50 border-yellow-100'}`}>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className={`text-sm font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Why Practice Object Location?</h3>
                    </div>
                    <ul className={`text-xs space-y-2 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                      <li className="flex items-start gap-2">
                        ...
                        Directly transfers to real-world spatial memory like remembering parking spots
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-3 h-3 text-yellow-500 mt-0.5 flex-shrink-0" />
                        Builds the ability to track multiple object positions simultaneously
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-3 h-3 text-yellow-500 mt-0.5 flex-shrink-0" />
                        Progressive grid expansion ensures continuous challenge and growth
                      </li>
                    </ul>
                  </div>
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-orange-50 border-orange-100'}`}>
                    ...
                    <ol className={`text-xs space-y-2 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                      <li className="flex items-start gap-2">
                        ...
                        Mentally note each object's position relative to grid corners or edges
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        Create a mental story connecting object locations for easier recall
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        Focus on accuracy first as grid size expands automatically with correct answers
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        Practice 10-15 minutes daily for best spatial memory improvement
                      </li>
                    </ol>
                  </div>
                </div>
        ...
        {!isFullscreen && (
          <section className="mt-8" aria-label="Related memory and cognitive drills">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-1 h-6 rounded-full bg-gradient-to-b from-emerald-500 to-green-600"></div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <Link href="/drills/memory/spatial-memory/grid-memorization" className={`group relative overflow-hidden rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${isDarkMode ? 'bg-gray-800 border-gray-700 hover:border-blue-500' : 'bg-white border-gray-200 hover:border-blue-300'}`}>
                ...
                <div className="p-4">
                  ...
                  <h3 className={`font-semibold text-sm mb-1 ${isDarkMode ? 'text-white group-hover:text-blue-400' : 'text-gray-900 group-hover:text-blue-600'} transition-colors`}>Grid Memorization</h3>
              ...
              <Link href="/drills/memory/short-term-memory/color-sequence" className={`group relative overflow-hidden rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${isDarkMode ? 'bg-gray-800 border-gray-700 hover:border-green-500' : 'bg-white border-gray-200 hover:border-green-300'}`}>
                ...
                <div className="p-4">
                  ...
                  <h3 className={`font-semibold text-sm mb-1 ${isDarkMode ? 'text-white group-hover:text-green-400' : 'text-gray-900 group-hover:text-green-600'} transition-colors`}>Color Sequence</h3>
              ...
              <Link href="/drills/memory/short-term-memory/digit-span" className={`group relative overflow-hidden rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${isDarkMode ? 'bg-gray-800 border-gray-700 hover:border-purple-500' : 'bg-white border-gray-200 hover:border-purple-300'}`}>
              ...
              <Link href="/drills/memory/associative-memory/concept-linking" className={`group relative overflow-hidden rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${isDarkMode ? 'bg-gray-800 border-gray-700 hover:border-cyan-500' : 'bg-white border-gray-200 hover:border-cyan-300'}`}>
                ...
                <div className="p-4">
                  ...
                  <h3 className={`font-semibold text-sm mb-1 ${isDarkMode ? 'text-white group-hover:text-cyan-400' : 'text-gray-900 group-hover:text-cyan-600'} transition-colors`}>Concept Linking</h3>
              ...
              <Link href="/drills/memory/long-term-memory/paired-associates" className={`group relative overflow-hidden rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${isDarkMode ? 'bg-gray-800 border-gray-700 hover:border-red-500' : 'bg-white border-gray-200 hover:border-red-300'}`}>
              ...
              <Link href="/drills/memory/short-term-memory/word-recall" className={`group relative overflow-hidden rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${isDarkMode ? 'bg-gray-800 border-gray-700 hover:border-teal-500' : 'bg-white border-gray-200 hover:border-teal-300'}`}>
                ...
                <div className="p-4">
                  ...
                  <h3 className={`font-semibold text-sm mb-1 ${isDarkMode ? 'text-white group-hover:text-teal-400' : 'text-gray-900 group-hover:text-teal-600'} transition-colors`}>Word Recall</h3>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8 mb-8">
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    <li><Link href="/drills/memory/spatial-memory/object-location" className="hover:text-white transition-colors">Object Location</Link></li>
              ...
              <div className="border-t border-gray-800 pt-8 text-center">
                ...
                <p className="text-xs max-w-2xl mx-auto leading-relaxed mb-6">
                  Free online object location drill for spatial position memory training. 10 unique emoji objects on expanding grids from 3×3 to 7×7. 3-4 second memorization with auto-advancing rounds. Perfect for students professionals and anyone wanting to improve visual-spatial memory. No registration required. More free memory drills at skilldrills.online.
                </p>
                <div className="flex items-center justify-center gap-5 flex-wrap">
                  <button onClick={sharePage} className="text-gray-500 hover:text-white transition-colors" title="Share this drill" aria-label="Share this free object location drill">
