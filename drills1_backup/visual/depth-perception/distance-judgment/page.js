...
export const metadata = {
  ...
  keywords: [
    "distance judgment",
    "distance judgment training",
    "distance judgment game",
    "distance judgment test",
    "distance judgment online",
    "free distance judgment",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/visual/distance-judgment',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Distance Judgment - Depth Perception | SkillDrills",
    description: "Train depth perception by intercepting a moving sphere at target depth. Color feedback green/yellow/red, auto-leveling speed. 60-second challenge. No sign-up.",
    url: 'https://skilldrills.online/drills/visual/distance-judgment',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Distance Judgment - Depth Perception | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function DistanceJudgmentPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Distance Judgment drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Distance Judgment?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Distance Judgment drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Distance Judgment drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Distance Judgment?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Distance Judgment drill completely free?</h4>
