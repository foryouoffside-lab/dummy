...
export const metadata = {
  ...
  description: "Free hand eye coordination game. Play free in your browser with no downloads or registration required.",
  keywords: [
    "cross body movement",
    "cross body movement training",
    "cross body movement game",
    "cross body movement test",
    "cross body movement online",
    "free cross body movement",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/physical/cross-body-movement',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Hand Eye Coordination Game - Cross-Body Movement Training | SkillDrills",
    description: "Free hand eye coordination game. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/physical/cross-body-movement',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Hand Eye Coordination Game - Cross-Body Movement Training | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function CrossBodyMovementPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Cross Body Movement?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Cross Body Movement drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Cross Body Movement drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Cross Body Movement?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Cross Body Movement drill completely free?</h4>
