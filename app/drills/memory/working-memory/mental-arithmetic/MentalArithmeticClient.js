    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: 'Free Mental Arithmetic Drill | SkillDrills',
          text: 'Train working memory with timed mental math problems. Free!',
          url: 'https://skilldrills.online/drills/memory/working-memory/mental-arithmetic'
        });
      } catch (e) {}
    } else {
      navigator.clipboard.writeText('https://skilldrills.online/drills/memory/working-memory/mental-arithmetic');
      alert('Link copied!');
    }
  };
  ...
  return (
    <div className={`min-h-screen select-none ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "Mental Arithmetic Drill - Working Memory & Mental Calculation Training",
            "url": "https://skilldrills.online/drills/memory/working-memory/mental-arithmetic",
            "description": "Free working memory drill with timed mental arithmetic across 4 operations addition subtraction multiplication and division. 10-second time limit per problem with auto-advance. 8 difficulty levels scaling with score. 60-second timed challenge with +1 correct -1 wrong scoring and streak tracking.",
            "applicationCategory": "EducationalApplication",
            "operatingSystem": "All",
            "offers": { "@type": "Offer", "price": "0", "priceCurrency": "USD", "availability": "https://schema.org/OnlineOnly" },
            "author": { "@type": "Organization", "name": "SkillDrills", "url": "https://skilldrills.online" },
            "publisher": { "@type": "Organization", "name": "SkillDrills" },
            "educationalUse": ["Working Memory Training", "Mental Calculation Practice", "Arithmetic Skills", "Numerical Fluency", "Cognitive Training"],
            "learningResourceType": ["Interactive Exercise", "Math Drill", "Cognitive Training"],
            "timeRequired": "PT60S",
            "interactivityType": "active",
            "inLanguage": "en-US",
            "teaches": ["Mental Arithmetic", "Working Memory", "Mental Calculation", "Numerical Fluency", "Mathematical Processing"],
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={`text-sm sm:text-base ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                  Free working memory math drill • +1/-1 scoring • 10s per problem • 60s challenge
                </p>
              </div>
            </div>
      ...
      {showRotateWarning && (
        ...
        {!isFullscreen && (
          <section className="mt-8" aria-label="About this mental arithmetic drill">
            <div className={`rounded-xl border overflow-hidden ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
              <div className={`px-4 py-3 border-b ${isDarkMode ? 'border-gray-700 bg-gray-800/50' : 'border-gray-200 bg-gray-50'}`}>
                <div className="flex items-center gap-2">
                  <GraduationCap className={`w-5 h-5 ${isDarkMode ? 'text-blue-400' : 'text-blue-600'}`} aria-hidden="true" />
                  <h2 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>About This Free Mental Arithmetic Drill</h2>
                </div>
              </div>
              <div className="p-5">
                <p className={`text-sm leading-relaxed mb-5 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  This free mental arithmetic drill trains working memory by challenging you to solve math problems entirely in your head under time pressure. With 4 operations (addition, subtraction, multiplication, division), each problem gives you 10 seconds to calculate and submit the answer. The difficulty scales across 8 levels based on your current score, with numbers growing larger and operations becoming more complex as you improve. The 10-second timer with visual countdown turns red when under 3 seconds, adding urgency to every problem. Wrong answers and timeouts show the correct answer so you learn from each attempt. Perfect for students strengthening math fluency, professionals sharpening mental calculation, seniors maintaining cognitive function, and anyone wanting to improve working memory and numerical processing speed.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-5">
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-blue-50 border-blue-100'}`}>
                    ...
                    <p className={`text-xs leading-relaxed ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                      Students strengthening math fluency, professionals sharpening mental calculation, seniors maintaining cognitive function, and anyone wanting to improve working memory and numerical processing speed.
                    </p>
                  </div>
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-green-50 border-green-100'}`}>
                    ...
                    <p className={`text-xs leading-relaxed ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                      Working memory capacity, mental calculation speed, numerical fluency, mathematical processing, concentration under time pressure, and the ability to hold and manipulate numbers mentally.
                    </p>
                  </div>
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-purple-50 border-purple-100'}`}>
                    ...
                    <p className={`text-xs leading-relaxed ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                      Score, accuracy percentage, streak count, problems completed, difficulty level progression, 10-second timer with red warning, and best performance records saved locally.
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-yellow-50 border-yellow-100'}`}>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className={`text-sm font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Why Practice Mental Arithmetic?</h3>
                    </div>
                    <ul className={`text-xs space-y-2 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                      <li className="flex items-start gap-2">
                        ...
                        Strengthens working memory by holding and manipulating numbers mentally
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-3 h-3 text-yellow-500 mt-0.5 flex-shrink-0" />
                        Builds numerical fluency essential for academic and professional success
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-3 h-3 text-yellow-500 mt-0.5 flex-shrink-0" />
                        Adaptive difficulty ensures continuous challenge across all skill levels
                      </li>
                    </ul>
                  </div>
                  <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-700/50 border-gray-600' : 'bg-orange-50 border-orange-100'}`}>
                    ...
                    <ol className={`text-xs space-y-2 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                      <li className="flex items-start gap-2">
                        ...
                        Calculate mentally without writing or using fingers
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        Focus on accuracy first then build speed as confidence grows
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        Review correct answers shown on wrong/timeout responses
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        Practice 10-15 minutes daily for best mental arithmetic improvement
                      </li>
                    </ol>
                  </div>
                </div>
        ...
        {!isFullscreen && (
          <section className="mt-8" aria-label="Related memory and cognitive drills">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Link href="/drills/memory/short-term-memory/word-recall" className={`group relative overflow-hidden rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${isDarkMode ? 'bg-gray-800 border-gray-700 hover:border-cyan-500' : 'bg-white border-gray-200 hover:border-cyan-300'}`}>
                ...
                <div className="p-4">
                  ...
                  <h3 className={`font-semibold text-sm mb-1 ${isDarkMode ? 'text-white group-hover:text-cyan-400' : 'text-gray-900 group-hover:text-cyan-600'} transition-colors`}>Word Recall</h3>
              ...
              <Link href="/drills/memory/spatial-memory/path-tracing" className={`group relative overflow-hidden rounded-xl border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${isDarkMode ? 'bg-gray-800 border-gray-700 hover:border-teal-500' : 'bg-white border-gray-200 hover:border-teal-300'}`}>
                ...
                <div className="p-4">
                  ...
                  <h3 className={`font-semibold text-sm mb-1 ${isDarkMode ? 'text-white group-hover:text-teal-400' : 'text-gray-900 group-hover:text-teal-600'} transition-colors`}>Path Tracing</h3>
                  <p className={`text-xs leading-relaxed ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>Watch animated dot paths then retrace them in exact order on expanding grids.</p>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="border-t border-gray-800 pt-8 text-center">
                ...
                <p className="text-xs max-w-2xl mx-auto leading-relaxed mb-6">
                  Free online mental arithmetic drill for working memory training. 4 operations with 8 adaptive difficulty levels. 10-second timer per problem with auto-advance. Perfect for students professionals and anyone wanting to improve mental calculation speed. No registration required. More free memory drills at skilldrills.online.
                </p>
                <div className="flex items-center justify-center gap-5 flex-wrap">
                  <button onClick={sharePage} className="text-gray-500 hover:text-white transition-colors" title="Share this drill" aria-label="Share this free mental arithmetic drill">
