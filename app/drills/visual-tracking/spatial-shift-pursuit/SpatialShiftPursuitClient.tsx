...
export default function SpatialShiftPursuitClient() {
  ...
  useEffect(() => {
    ...
    try {
      const stored = localStorage.getItem('visualTrackingSpatialShiftPursuitClientTrialsCount');
        ...
        setTimeLeft(p => {
          if (p <= 1) {
            ...
            setTotalTrials(prev => {
              const next = prev + 1;
              try {
                localStorage.setItem('visualTrackingSpatialShiftPursuitClientTrialsCount', next.toString());
              } catch (e) {}
              return next;
            });
      ...
      // Update velocity shifts
        ...
        if (trailEffect) {
          ...
          for (let i = 0; i < trailArr.length; i++) {
            ...
            ctx.globalAlpha = (i / trailArr.length) * 0.18;
            ctx.beginPath();
    ...
    if (typeof navigator !== 'undefined' && navigator.share) {
      try {
        await navigator.share({
          title: 'Free Spatial-Shift Pursuit Drill | SkillDrills',
      ...
      navigator.clipboard.writeText('https://skilldrills.online/drills/visual-tracking/spatial-shift-pursuit');
        ...
        {!isFullscreen && (
          <nav aria-label="Breadcrumb" className="mb-5">
            <ol className="flex items-center gap-2 text-[10px] text-slate-550 uppercase tracking-widest font-mono">
              ...
              <li><span className="text-slate-755">/</span></li>
              <li><span className="text-red-400 font-bold">Spatial-Shift Pursuit</span></li>
            </ol>
          </nav>
        )}
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 tracking-wider mt-0.5">
                  Visual Gaze Calibration • Intermediate Sector
                </p>
              </div>
            </div>
                ...
                <div className="absolute inset-0 bg-[#05070e]/95 flex flex-col items-center justify-center p-6 z-30 select-none">
                  <div className="max-w-md text-center">
                    ...
                    <p className="text-xs text-slate-400 leading-relaxed mb-6">
                      Track a bouncing target that undergoes randomized shifts in speed and direction. Focus your eyes on the moving target. Do not use your head or mouse.
                    </p>
            ...
            <div className="md:col-span-2 bg-[#0b0f19]/40 border border-slate-900 p-6 rounded-2xl flex flex-col justify-between">
              <div>
                ...
                <p className="text-xs leading-relaxed text-slate-400 mb-4 font-sans">
                  The Spatial-Shift Pursuit Drill focuses on predictive tracking under erratic acceleration changes. By randomly shifting the velocity vector, the drill challenges the eye to transition from smooth pursuit to quick saccadic updates. Clamping safeguards keep velocity within professional training thresholds.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#0b0f19]/40 border border-slate-905 p-6 rounded-2xl">
              ...
              <ul className="space-y-3 text-xs text-slate-400 font-mono">
                <li className="flex items-start gap-2">
                  ...
                  <span><strong>Acceleration Recalibration</strong>: Adapts foveal tracking to sudden acceleration peaks.</span>
                </li>\n                <li className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                  <span><strong>Predictive Adaptability</strong>: Reduces latency when targets change trajectory lines.</span>
                </li>\n                <li className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                  <span><strong>Directional Shifts</strong>: Overclocks tracking accuracy under rapid vector changes.</span>
                </li>\n
              </ul>
            </div>
          </div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="border-t border-slate-900 pt-8 text-center">
                ...
                <p className="text-[10px] max-w-2xl mx-auto leading-relaxed mb-6 font-sans text-slate-700">
                  Free online Spatial-Shift Pursuit drill for visual gaze tracking and foveal stability training. Train foveal pursuit and coordinate re-acquisition speeds under speed configurations. Perfect for gamers, athletes, and attention diagnostics. No registration required. More free drills at skilldrills.online.
                </p>
