...
const guide = {
  ...
  intro: [
    ...
    "Die Übung 'Zickzack-Blickverfolgung (Zig-Zag Path Pursuit)' wurde entwickelt, um diese hochdynamische Vektorkontrolle online zu trainieren. Durch das wiederholte Bewältigen spitzer Richtungswechsel eliminieren Sie Unruhe und Reaktionsverzögerungen beim Tracking unregelmäßig manövrierender Ziele. Nutzen Sie 'Hide Line' für reines internes Raumtracking und 'Random Speed' zur Ausschaltung starrer Rhythmusmuster. In Kombination mit moderner Low-Latency-Hardware (Woods et al., 2015) erlangen Sie maximale Blickdisziplin und Wettkampfpräzision."
  ],
  benchmarks: {
