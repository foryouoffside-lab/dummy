...
const GAME_YAWS = {
  ...
  useEffect(() => {
    ...
    // Tiny micro scale S+ target: 8px representing Valorant/CS2 heads at long-range (50m)
    if (gameType === 'valorant' || gameType === 'cs2') {
      setCurrentTargetSize(8);
    } else {
      setCurrentTargetSize(12);
    }
  ...
  useEffect(() => {
    ...
    function draw(ct) {
      ...
      // Draw Reticle (compact crosshair for elite gamers)
      const ch = virtualCrosshair.current;
