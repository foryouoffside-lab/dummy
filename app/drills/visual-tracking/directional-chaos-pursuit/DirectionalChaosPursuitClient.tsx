...
export default function DirectionalChaosPursuitClient({ copy }: { copy?: { title?: string; subtitle?: string; description?: string } } = {}) {
  ...
  const sharePage = useCallback(async () => {
    ...
    try {
      ...
      const text = 'Directional Chaos Pursuit — Free Erratic Motion Eye Drill!';
      if (typeof navigator !== 'undefined' && navigator.share) {
        try {
          await navigator.share({ title: 'Directional Chaos Pursuit - Erratic Motion Eye Drill', text, url });
        } catch (e) {}
