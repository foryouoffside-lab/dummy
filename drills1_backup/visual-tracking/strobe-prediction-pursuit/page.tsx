...
export const metadata = {
  ...
  keywords: [
    ...
    "strobe prediction pursuit training",
    "strobe prediction pursuit game",
    "strobe prediction pursuit test",
    "strobe prediction pursuit online",
    "free strobe prediction pursuit",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Strobe Prediction Pursuit - Visual Pursuit & Tracking Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function StrobePredictionPursuitPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Strobe Prediction Pursuit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Strobe Prediction Pursuit drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Strobe Prediction Pursuit drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Strobe Prediction Pursuit?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Strobe Prediction Pursuit drill completely free?</h4>
