...
export const metadata = {
  title: "Digit Span - Memory Training & Focus Drill | SkillDrills",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/memory/digit-span',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Digit Span - Memory Training & Focus Drill | SkillDrills",
    description: "Train numerical memory with infinite progressive digit sequences. 3-second memorization, then type the exact sequence. Auto-adjusting font size. No sign-up.",
    url: 'https://skilldrills.online/drills/memory/digit-span',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Digit Span - Memory Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function DigitSpanPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Digit Span?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Digit Span drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Digit Span drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Digit Span?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Digit Span drill completely free?</h4>
