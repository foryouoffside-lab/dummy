        ...
        {!isFullscreen && (
          <section className="mt-14" aria-label="Explore related hand eye coordination games">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <RelatedCard href="/drills/motor/hand-eye-coordination/precision-flick-shot" title="Tracking Game" desc="Smooth pursuit mouse control training." color="blue" icon={<Crosshair className="w-4 h-4" />} />
            </div>
          </section>
        )}
