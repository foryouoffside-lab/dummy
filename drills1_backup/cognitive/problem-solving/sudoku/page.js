...
export const metadata = {
  title: "Sudoku Drill - Cognitive Training & Focus Drill | SkillDrills",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/cognitive/sudoku',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Sudoku Drill - Cognitive Training & Focus Drill | SkillDrills",
    description: "Master Sudoku from 4x4 to 7x7 grids with progressive difficulty. 60-second challenge, combo streaks, and Sudoku Master achievement. No sign-up.",
    url: 'https://skilldrills.online/drills/cognitive/sudoku',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Sudoku Drill - Cognitive Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function SudokuPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Sudoku?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Sudoku drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Sudoku drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Sudoku?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Sudoku drill completely free?</h4>
