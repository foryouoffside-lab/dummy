...
export const metadata = {
  title: "Flow State - Fps Training & Focus Drill | SkillDrills",
  description: "Track a moving ring to achieve flow state. Play free in your browser with no downloads or registration required.",
  keywords: [
    "flow state",
    "flow state training",
    "flow state game",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Flow State - Fps Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function FlowInductionPage() {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "url": "https://skilldrills.online/drills/visual/tracking-accuracy/flow-state",
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Flow State drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Flow State?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Flow State drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Flow State drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Flow State?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Flow State drill completely free?</h4>
