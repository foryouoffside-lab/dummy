        ...
        <header className="border-b border-white/5 bg-[#080811]/80 backdrop-blur-md sticky top-0 z-50">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            <div className="flex items-center gap-2 text-xs text-slate-400">
              ...
              <span>/</span>
              <span className="text-red-400 font-medium">Strobe Prediction Pursuit</span>
            </div>
          ...
          <div className="[&>div]:!mt-0">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-sans">
                <RuleItem num="1" text="Strobe Occlusion" highlight="Pure Visual" result="Predict target position in dark phase" />
            ...
            <DrillAccordion
              id="about"
              title="About Strobe Prediction Pursuit"
              ...
              <div className="space-y-6 font-sans">
                <section>
                  <h4 className="text-base font-bold text-white mb-2">
                    What Is Strobe Prediction Pursuit Training?
                  </h4>
                  <p className="text-sm leading-relaxed mb-3 text-gray-300">
                    <strong>Strobe Prediction Pursuit Training</strong> conditions visual trajectory extrapolation by periodically occluding the target in dark strobe phases, forcing your brain to predict continuous motion.
                  </p>
                  <p className="text-sm leading-relaxed text-gray-300">
                    By utilizing features like <strong>Hide Line</strong> and <strong>Random Speed Acceleration</strong>, your visual cortex learns to extrapolate target trajectories without ghost outline guides.
                  </p>
                </section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="p-4 rounded-xl border border-gray-800 bg-white/[0.02]">
                    ...
                    <p className="text-xs text-gray-300 leading-relaxed">Gamers, athletes, and vision training practitioners looking to build trajectory extrapolation.</p>
                  </div>
                  <div className="p-4 rounded-xl border border-gray-800 bg-white/[0.02]">
                    <h5 className="text-xs font-bold text-white mb-1.5">Visual Occlusion</h5>
                    <p className="text-xs text-gray-300 leading-relaxed">Conditions visual memory and ocular motor extrapolation during blank phases.</p>
                  </div>
                  <div className="p-4 rounded-xl border border-gray-800 bg-white/[0.02]">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-sans">
                <FAQItem q="What is the Strobe Prediction Pursuit drill?" a="The Strobe Prediction Pursuit drill conditions visual trajectory extrapolation by periodically occluding the target in dark strobe phases, forcing your brain to predict continuous motion." />
                <FAQItem q="Why use the 'Hide Line' setting?" a="Hiding ghost target outlines during the dark strobe phase forces pure mental extrapolation without visual reference cues." />
                <FAQItem q="What does the Random Speed feature do?" a="Random Speed modulates strobe flash frequency and velocity spikes unpredictably, strengthening ocular motor control." />
