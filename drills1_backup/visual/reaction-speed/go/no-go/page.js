...
export const metadata = {
  title: "Go/No - Visual Training & Focus Drill | SkillDrills",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/visual/no-go',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Go/No - Visual Training & Focus Drill | SkillDrills",
    description: "Train impulse control with Go/No-Go paradigm. Click GREEN, avoid RED. Adaptive 80-400ms window, 3 lives, reaction tracking. No sign-up.",
    url: 'https://skilldrills.online/drills/visual/no-go',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Go/No - Visual Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function ChromaSyncPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in No Go?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the No Go drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the No Go drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in No Go?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the No Go drill completely free?</h4>
