...
export const alt = 'Pattern Memory Game - Visual & Spatial Memory Training';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            Memorize increasingly complex paths and redraw them from memory to build visual and spatial memory.
          </div>
        </div>

        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          {['VISUAL MEMORY', 'SPATIAL RECALL', 'PATTERN TRACING', 'FREE — NO SIGN-UP'].map((label) => (
            <div
              key={label}
              style={{
                display: 'flex',
