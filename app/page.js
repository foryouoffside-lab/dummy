...
export const metadata = {
  ...
  description: 'Master your mind and mechanics with 135+ free interactive drills. Improve FPS aim, reaction time, memory, focus, typing speed, and mental fitness. No sign-up.',
  keywords: [
  ...
  openGraph: {
    ...
    description: '135+ free drills for FPS gaming, cognitive skills, memory, and mental fitness. No registration. Start now.',
  ...
  twitter: {
    ...
    description: '135+ free training drills. No sign-up required. Start training instantly.',
  ...
  return (
    <>
      <noscript>
        ...
        <p>Master your mind and mechanics with 135+ free interactive drills. No sign-up required.</p>
      </noscript>
      <HomePageClient />
    </>
  );
