...
export const metadata = {
  ...
  description: "Train visual scanning and focus by finding numbers in order on expanding 3x3 to 8x8 g... Play free in your browser with no downloads or registration required.",
  keywords: [
    "concentration grid",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/cognitive/concentration-grid',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Concentration Grid - Number Search | SkillDrills",
    description: "Train visual scanning and focus by finding numbers in order on expanding 3x3 to 8x8 g... Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/cognitive/concentration-grid',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Concentration Grid - Number Search | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function ConcentrationGridPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Concentration Grid?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Concentration Grid drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Concentration Grid drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Concentration Grid?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Concentration Grid drill completely free?</h4>
