...
export const alt = 'Kinetic Intercept — free browser Visual Training drill on SkillDrills';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            {"Click fast-moving white targets spawning from edges at 12-22 speed."}
          </div>
        </div>
