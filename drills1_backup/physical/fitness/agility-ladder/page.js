...
export const metadata = {
  ...
  description: "Free agility ladder drills online. Play free in your browser with no downloads or registration required.",
  keywords: [
    "agility ladder",
    "agility ladder training",
    "agility ladder game",
    "agility ladder test",
    "agility ladder online",
    "free agility ladder",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/physical/agility-ladder',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Agility Ladder Drills - Free Online Coordination Training | SkillDrills",
    description: "Free agility ladder drills online. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/physical/agility-ladder',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Agility Ladder Drills - Free Online Coordination Training | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function AgilityLadderPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Agility Ladder?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Agility Ladder drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Agility Ladder drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Agility Ladder?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Agility Ladder drill completely free?</h4>
