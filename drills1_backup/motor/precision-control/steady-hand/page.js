...
export const metadata = {
  ...
  description: "Free steady hand game online. Play free in your browser with no downloads or registration required.",
  keywords: [
    "steady hand",
    "steady hand training",
    "steady hand game",
    "steady hand test",
    "steady hand online",
    "free steady hand",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/motor/steady-hand',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Steady Hand Game - Free Mouse Path Tracing Drill | SkillDrills",
    description: "Free steady hand game online. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/motor/steady-hand',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Steady Hand Game - Free Mouse Path Tracing Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function SteadyHandPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Steady Hand drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Steady Hand?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Steady Hand drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Steady Hand drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Steady Hand?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Steady Hand drill completely free?</h4>
