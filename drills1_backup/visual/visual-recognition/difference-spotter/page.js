...
export const metadata = {
  ...
  keywords: [
    "difference spotter",
    "difference spotter training",
    "difference spotter game",
    "difference spotter test",
    "difference spotter online",
    "free difference spotter",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/visual/difference-spotter',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Difference Spotter - Change Detection | SkillDrills",
    description: "Train change detection with 5 objects. Spot which one changed position or color after a blink. Adaptive 2-5s study time. 3 lives. No sign-up.",
    url: 'https://skilldrills.online/drills/visual/difference-spotter',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Difference Spotter - Change Detection | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function DifferenceSpotterPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Difference Spotter?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Difference Spotter drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Difference Spotter drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Difference Spotter?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Difference Spotter drill completely free?</h4>
