...
export const metadata = {
  title: "Word Recall - Memory Training & Focus Drill | SkillDrills",
  description: "Train verbal memory with 50 unique words and progressive difficulty. Play free in your browser with no downloads or registration required.",
  keywords: [
    "word recall",
    "word recall training",
    "word recall game",
    "word recall test",
    "word recall online",
    "free word recall",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/memory/word-recall',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Word Recall - Memory Training & Focus Drill | SkillDrills",
    description: "Train verbal memory with 50 unique words and progressive difficulty. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/memory/word-recall',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Word Recall - Memory Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function WordRecallPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Word Recall?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Word Recall drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Word Recall drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Word Recall?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Word Recall drill completely free?</h4>
