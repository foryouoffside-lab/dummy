...
export const metadata = {
  title: "Tracking Aim Trainer - Free FPS Smooth Pursuit Practice | SkillDrills",
  ...
  keywords: [
    "pro smooth pursuit",
    "pro smooth pursuit training",
    "pro smooth pursuit game",
    "pro smooth pursuit test",
    "pro smooth pursuit online",
    "free pro smooth pursuit",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Tracking Aim Trainer - Free FPS Smooth Pursuit Practice | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function ProSmoothPursuitPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Pro Smooth Pursuit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Pro Smooth Pursuit drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Pro Smooth Pursuit drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Pro Smooth Pursuit?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Pro Smooth Pursuit drill completely free?</h4>
