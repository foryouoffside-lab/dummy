...
import { 
  ...
  BarChart3, Info, CheckCircle, Brain, X, RefreshCw
} from 'lucide-react';
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              {gameState === 'playing' && (
                <button onClick={resetDrill} className={`p-2 rounded-lg border transition-all hover:scale-105 active:scale-95 ${isDarkMode ? 'bg-gray-800 border-gray-700 text-gray-300' : 'bg-white border-gray-200 text-gray-700'}`} title="Reset session">
