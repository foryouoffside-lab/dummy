        ...
        <div className={isFullscreen ? "w-full h-full" : "block"}>
          ...
          <div 
            ...
            className={isFullscreen 
              ? "w-full h-full bg-[#030409] relative overflow-hidden flex items-center justify-center cursor-none" 
              : "w-full aspect-video min-h-[400px] lg:min-h-[500px] bg-[#030409] border border-slate-800 rounded-xl relative overflow-hidden flex items-center justify-center cursor-none"}
          >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 font-mono text-xs text-slate-400">
                  <div className="p-4 rounded-xl border border-slate-900 bg-[#0b0f19]/10">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="font-bold text-white uppercase tracking-wider">Why Practice S+ Elite Parabolic Air-Track?</h3>
                    </div>
