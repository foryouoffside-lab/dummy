...
export const metadata = {
  title: "Mental Math - Academic Training & Focus Drill | SkillDrills",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/academic/mental-math',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Mental Math - Academic Training & Focus Drill | SkillDrills",
    description: "Sharpen mental arithmetic with timed math drill. Addition, subtraction, and multiplication across 3 levels. 60-second challenge. No sign-up.",
    url: 'https://skilldrills.online/drills/academic/mental-math',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Mental Math - Academic Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function MentalMathPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Mental Math?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Mental Math drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Mental Math drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Mental Math?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Mental Math drill completely free?</h4>
