...
export default function FluidFilamentPage() {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      ctx.fillStyle = flowRef.current > 30 ? "#00ff88" : "#FF3E3E";
      ctx.fillRect(mX, mY, (flowRef.current / 100) * mWidth, mHeight);
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>Wave tracking • Flow state training</p>
              </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        <span className="font-semibold text-red-500">Follow the red wave</span> - Keep cursor within 30px of the filament
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        <span className="font-semibold text-cyan-500">Best Score saves locally</span> - Persists across sessions
                      </p>
                    </div>
                  </div>
                </div>
                <div className={`mt-3 pt-3 border-t text-xs ${isDarkMode ? 'border-gray-700 text-gray-400' : 'border-gray-200 text-gray-500'} flex items-center justify-between`}>
                  <span>🌊 Green ball = On wave • Gray ball = Off wave</span>
