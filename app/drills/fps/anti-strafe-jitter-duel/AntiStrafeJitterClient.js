        ...
        {!isFullscreen && (
          <section className="mt-14" aria-label="Explore related aim and response drills">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <RelatedCard href="/drills/fps/target-switching-swarm" title="Target Switching" desc="Flick and track target arrays." color="green" icon={<Target className="w-4 h-4" />} />
