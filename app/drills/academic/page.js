...
export default function AcademicDrillsPage() {
  return (
    <>
      {/* Single H1 for ALL crawlers - visually hidden but crawlable */}
      <h1 style={{ position: 'absolute', width: '1px', height: '1px', padding: '0', margin: '-1px', overflow: 'hidden', clip: 'rect(0,0,0,0)', whiteSpace: 'nowrap', border: '0' }}>
        Academic Training Drills - Math, Reading, Typing & Comprehension
      </h1>
      ...
      {/* FAQ Schema */}
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [ { "@type": "Question", "name": "What academic drills are available?", "acceptedAnswer": { "@type": "Answer", "text": "SkillDrills offers 12 free academic training drills across 4 categories: Math Speed (Arithmetic Race, Math Reaction, Mental Math, Multiplication Tables), Reading Speed (Speed Reader, RSVP Reader, Peripheral Reader), Writing Speed (Typing Test, Code Typing), and Comprehension (Reading Comprehension, Listening Comprehension, Inference Drill). All drills are free with no sign-up required." } }, { "@type": "Question", "name": "Are these academic drills helpful for exam preparation?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. The inference and comprehension drills help with LSAT, GMAT, GRE, SAT, ACT, CAT, UPSC, SSC, and banking exams. Mental math and speed reading drills improve calculation speed and reading efficiency essential for competitive exams." } }, { "@type": "Question", "name": "Do I need to create an account to practice?", "acceptedAnswer": { "@type": "Answer", "text": "No registration or login is required. All 12 academic drills are completely free and work instantly in your browser. Your best scores are saved locally on your device." } } ] }) }} />
