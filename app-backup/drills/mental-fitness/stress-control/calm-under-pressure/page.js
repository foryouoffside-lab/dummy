...
export default function CalmUnderPressurePage() {
  ...
  const startCognitiveLoad = () => {
    ...
    showFeedback(`🧠 Cognitive Load Active!`, 'warning');
  ...
  const stopCognitiveLoad = () => {
    ...
    setShowNumber(false);
    showFeedback(`🧘 Cognitive Load Ended`, 'success');
  };
            ...
            <div className={`rounded-xl border overflow-hidden ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
              ...
              <div className="p-4">
                ...
                <div className={`mt-3 pt-3 border-t text-xs ${isDarkMode ? 'border-gray-700 text-gray-400' : 'border-gray-200 text-gray-500'} flex items-center justify-between`}>
                  <span>🧠 Improves focus under distraction and cognitive flexibility</span>
                  <span>🎵 523Hz inhale • 392Hz exhale • 880Hz load tone</span>
                </div>
              </div>
            </div>
          </div>
