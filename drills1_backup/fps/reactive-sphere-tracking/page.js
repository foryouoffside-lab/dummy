...
export const metadata = {
  title: "Tracking Aim Trainer - Free Reactive Tracking Practice | SkillDrills",
  ...
  keywords: [
    ...
    "reactive sphere tracking training",
    "reactive sphere tracking game",
    "reactive sphere tracking test",
    "reactive sphere tracking online",
    "free reactive sphere tracking",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Tracking Aim Trainer - Free Reactive Tracking Practice | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function ReactiveSphereTrackingPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Reactive Sphere Tracking drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Reactive Sphere Tracking?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Reactive Sphere Tracking drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Reactive Sphere Tracking drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Reactive Sphere Tracking?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Reactive Sphere Tracking drill completely free?</h4>
