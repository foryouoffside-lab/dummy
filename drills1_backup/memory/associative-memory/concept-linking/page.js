...
export const metadata = {
  ...
  keywords: [
    "concept linking",
    "concept linking training",
    "concept linking game",
    "concept linking test",
    "concept linking online",
    "free concept linking",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/memory/concept-linking',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Concept Linking - Associative Memory | SkillDrills",
    description: "Train associative memory by memorizing concept chains for 5 seconds then recalling step by step. 30 unique chains, 3 categories. Chains grow up to 8 concepts. No sign-up.",
    url: 'https://skilldrills.online/drills/memory/concept-linking',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Concept Linking - Associative Memory | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function ConceptLinkingPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Concept Linking?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Concept Linking drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Concept Linking drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Concept Linking?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Concept Linking drill completely free?</h4>
