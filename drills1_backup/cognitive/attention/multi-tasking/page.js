...
export const metadata = {
  title: "Dual - Cognitive Training & Focus Drill | SkillDrills",
  description: "Two shape streams with different targets from 8 types. Play free in your browser with no downloads or registration required.",
  keywords: [
    "multi tasking",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/cognitive/multi-tasking',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Dual - Cognitive Training & Focus Drill | SkillDrills",
    description: "Two shape streams with different targets from 8 types. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/cognitive/multi-tasking',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Dual - Cognitive Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function DualTargetFlowPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Multi Tasking drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Multi Tasking?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Multi Tasking drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Multi Tasking drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Multi Tasking?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Multi Tasking drill completely free?</h4>
