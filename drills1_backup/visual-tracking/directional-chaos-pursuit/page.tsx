...
export const metadata = {
  title: "Directional Chaos Pursuit - Visual Pursuit & Tracking Drill | SkillDrills",
  description: "Track a bouncing target subjected to continuous chaotic velocity nudges. Train visual pursuit tracking and coordinate re-acquisition speeds. No sign-up required.",
  keywords: [
    "directional chaos pursuit",
    "directional chaos pursuit training",
    "directional chaos pursuit game",
    "directional chaos pursuit test",
    "directional chaos pursuit online",
    "free directional chaos pursuit",
    "visual tracking exercises",
    "smooth pursuit eye tracking",
    "ocular motility exercises",
    "gaze stabilization training",
    "foveal pursuit exercises",
    "dynamic target tracking",
    "saccadic sweep training",
    "eye coordination exercises",
    "visual cortex conditioning"
],
  alternates: {
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Directional Chaos Pursuit - Visual Pursuit & Tracking Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function DirectionalChaosPursuitPage() {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Directional Chaos Pursuit" }
            ]
          })
        }}
      />
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Directional Chaos Pursuit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "This drill is specifically designed to target and improve your visual-tracking capabilities, including reaction latency, visual search efficiency, spatial coordination, and fine motor precision."
      }
    },
    {
      "@type": "Question",
      "name": "Is the Directional Chaos Pursuit drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Directional Chaos Pursuit drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Directional Chaos Pursuit?</h4>
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1.5 leading-relaxed">This drill is specifically designed to target and improve your visual-tracking capabilities, including reaction latency, visual search efficiency, spatial coordination, and fine motor precision.</p>
            </div>
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Directional Chaos Pursuit drill completely free?</h4>
