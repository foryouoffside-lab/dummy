...
export const metadata = {
  ...
  description: "Free flick training online. Play free in your browser with no downloads or registration required.",
  keywords: [
    "gesture speed",
    "gesture speed training",
    "gesture speed game",
    "gesture speed test",
    "gesture speed online",
    "free gesture speed",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/motor/gesture-speed',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Flick Training Online - Free Gesture Speed Drill | SkillDrills",
    description: "Free flick training online. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/motor/gesture-speed',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Flick Training Online - Free Gesture Speed Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function GestureSpeedPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Gesture Speed drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Gesture Speed?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Gesture Speed drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Gesture Speed drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Gesture Speed?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Gesture Speed drill completely free?</h4>
