...
export const metadata = {
  title: "FPS Tracking Trainer - Strafe Target Aim Practice | SkillDrills",
  description: "Train reaction speed, visual tracking, reflexes, and FPS tracking coordination with this free strafe aim trainer. Optimize fast reactions with no signup.",
  keywords: [
    "fps tracking trainer",
    "fps tracking trainer training",
    "fps tracking trainer game",
    "fps tracking trainer test",
    "fps tracking trainer online",
    "free fps tracking trainer",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "FPS Tracking Trainer - Strafe Target Aim Practice | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function FPSTrackingTrainerPage() {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "FPS Tracking Trainer" }
            ]
          })
        }}
      />
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Fps Tracking Trainer drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Fps Tracking Trainer?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Fps Tracking Trainer drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Fps Tracking Trainer?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Fps Tracking Trainer drill completely free?</h4>
