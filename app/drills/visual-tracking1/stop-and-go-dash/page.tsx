...
export const metadata = {
  title: 'Stop And Go Dash - Visual Pursuit & Tracking Drill | SkillDrills',
  ...
  keywords: ['stop and go dash', 'visual tracking drill', 'smooth pursuit eye training', 'saccadic eye movement test', 'visual processing speed', 'foveal tracking', 'esports vision training', 'athletic vision drill'],
  openGraph: {
    title: 'Stop And Go Dash - Visual Pursuit & Tracking Drill | SkillDrills',
    description: 'Track a target that rests in position and executes rapid ease-out dashes to random locations. Train visual pursuit tracking and coordinate re-acquisition speeds. No sign-up required.',
    type: 'article',
