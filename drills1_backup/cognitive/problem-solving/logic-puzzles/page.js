...
export const metadata = {
  title: "Logic Puzzles - Cognitive Training & Focus Drill | SkillDrills",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/cognitive/logic-puzzles',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Logic Puzzles - Cognitive Training & Focus Drill | SkillDrills",
    description: "Solve 8 types of unique logic puzzles including arithmetic, algebra, PEMDAS, Fibonacci, and percentages. 60-second challenge with hint system. No sign-up.",
    url: 'https://skilldrills.online/drills/cognitive/logic-puzzles',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Logic Puzzles - Cognitive Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function LogicPuzzlesPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Logic Puzzles drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Logic Puzzles?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Logic Puzzles drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Logic Puzzles drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Logic Puzzles?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Logic Puzzles drill completely free?</h4>
