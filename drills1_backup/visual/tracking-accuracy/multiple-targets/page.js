...
export const metadata = {
  title: "Ghost - Visual Training & Focus Drill | SkillDrills",
  ...
  keywords: [
    ...
    "multiple targets game",
    "multiple targets test",
    "multiple targets online",
    "free multiple targets",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/visual/multiple-targets',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Ghost - Visual Training & Focus Drill | SkillDrills",
    description: "2 green targets among 11 moving balls. 2-second preview, 60s tracking, then identify. 10pts per correct ball. MOT paradigm. No sign-up.",
    url: 'https://skilldrills.online/drills/visual/multiple-targets',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Ghost - Visual Training & Focus Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function GhostLinkPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Multiple Targets drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Multiple Targets?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Multiple Targets drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Multiple Targets drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Multiple Targets?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Multiple Targets drill completely free?</h4>
