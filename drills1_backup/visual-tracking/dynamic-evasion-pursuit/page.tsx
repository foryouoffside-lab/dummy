...
export const metadata = {
  title: "Dynamic Evasion Pursuit - Visual Pursuit & Tracking Drill | SkillDrills",
  description: "Overclock tracking responses against rapid directional changes at constant speed scales. Play free in your browser with no downloads or registration required.",
  keywords: [
    "dynamic evasion pursuit",
    "dynamic evasion pursuit training",
    "dynamic evasion pursuit game",
    "dynamic evasion pursuit test",
    "dynamic evasion pursuit online",
    "free dynamic evasion pursuit",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Dynamic Evasion Pursuit - Visual Pursuit & Tracking Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function DynamicEvasionPursuitPage() {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Dynamic Evasion Pursuit" }
            ]
          })
        }}
      />
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Dynamic Evasion Pursuit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Dynamic Evasion Pursuit drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Dynamic Evasion Pursuit drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Dynamic Evasion Pursuit?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Dynamic Evasion Pursuit drill completely free?</h4>
