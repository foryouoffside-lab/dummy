...
export const metadata = {
  ...
  description: "Free reflex test online. Play free in your browser with no downloads or registration required.",
  keywords: [
    "drop catch",
    "drop catch training",
    "drop catch game",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/physical/drop-catch',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Free Reflex Test Online - Drop Catch Reaction Speed Game | SkillDrills",
    description: "Free reflex test online. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/physical/drop-catch',
...
export default function DropCatchPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Drop Catch drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Drop Catch?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Drop Catch drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Drop Catch drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Drop Catch?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Drop Catch drill completely free?</h4>
