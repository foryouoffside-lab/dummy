...
export default function MultiplicationDrill() {
  ...
  const handleOptionSelect = (selectedAnswer) => {
    ...
    if (selectedAnswer === currentProblem.answer) {
      ...
      playSound('wrong');
      showFeedback(`✗ Wrong! ${currentProblem.a} × ${currentProblem.b} = ${currentProblem.answer}. -8`, 'error');
  ...
  return (
    <div className={`min-h-screen select-none ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Stats Board - Factor Recall specific metrics */}
        <div className="grid grid-cols-7 gap-3 mb-4 h-[88px]">
          ...
          <StatCard icon={<Hash className="text-cyan-600" />} value={`${range}×${range}`} label="Range" isDark={isDarkMode} />
        </div>
        ...
        {gameState === 'start' && (
          <div className="flex justify-center gap-3 mb-4">
            <select 
              ...
              className={`px-6 py-2 rounded-xl text-sm font-bold outline-none border ${
                isDarkMode 
                  ? 'bg-gray-800 border-gray-700 text-white' 
                  : 'bg-white border-gray-200 text-gray-700'
              }`}
            >
              <option value={12}>Up to 12×12</option>
              <option value={15}>Up to 15×15</option>
              <option value={20}>Up to 20×20</option>
            </select>
          </div>
        )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Correct: <span className="font-semibold text-green-500">15 points + combo bonus</span></p>
                    </div>
                    <div className="flex items-start gap-2">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Every 3 correct = <span className="font-semibold text-blue-500">+5 combo bonus</span></p>
                    </div>
                    <div className="flex items-start gap-2">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Auto-advances to <span className="font-semibold text-yellow-500">next question</span></p>
                    </div>
                  </div>
                </div>
