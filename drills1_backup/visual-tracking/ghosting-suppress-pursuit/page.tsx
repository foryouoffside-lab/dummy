...
export const metadata = {
  ...
  keywords: [
    ...
    "ghosting suppress pursuit training",
    "ghosting suppress pursuit game",
    "ghosting suppress pursuit test",
    "ghosting suppress pursuit online",
    "free ghosting suppress pursuit",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Ghosting Suppress Pursuit - Visual Pursuit & Tracking Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function GhostingSuppressPursuitPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Ghosting Suppress Pursuit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Ghosting Suppress Pursuit drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Ghosting Suppress Pursuit drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Ghosting Suppress Pursuit?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Ghosting Suppress Pursuit drill completely free?</h4>
