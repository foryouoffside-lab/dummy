...
export const metadata = {
  title: 'Slow Precision Tracking - Visual Pursuit & Tracking Drill | SkillDrills',
  ...
  keywords: ['slow precision tracking', 'visual tracking drill', 'smooth pursuit eye training', 'saccadic eye movement test', 'visual processing speed', 'foveal tracking', 'esports vision training', 'athletic vision drill'],
  openGraph: {
    title: 'Slow Precision Tracking - Visual Pursuit & Tracking Drill | SkillDrills',
    description: 'Deliberate horizontal plane pursuit with discrete vertical level transitions. Recalibrate smooth eye movements and vertical saccades. Train visual pursuit tracking and coordinate re-acquisition speeds. No sign-up required.',
    type: 'article',
