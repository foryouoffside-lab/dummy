  ...
  return (
    <div className={`min-h-screen select-none ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "name": "Calibrated Dynamic Flow - Fine Motor Tracking Drill",
        "url": "https://skilldrills.online/drills/motor/precision-control/fine-motor",
        "description": "Fine motor precision drill tracking a dynamically scrolling wave path. +1 point per second on path with no penalties. Two phases: Dynamic (0-30s) and Extreme (30-60s). Adaptive scroll speed.",
        "applicationCategory": "GameApplication", "operatingSystem": "Web",
        "offers": { "@type": "Offer", "price": "0", "priceCurrency": "USD" },
        "author": { "@type": "Organization", "name": "Global Drill System" },
        "educationalUse": ["Fine Motor Control", "Path Tracking", "Mouse Precision", "Steady Hand Training"],
        "learningResourceType": "Interactive Exercise", "timeRequired": "PT60S",
        "interactivityType": "active", "inLanguage": "en-US",
        "teaches": ["Cursor Control", "Smooth Movement", "Path Following", "Fine Motor Precision"]
      })}} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-3"><div className="p-3 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl flex-shrink-0"><Waves className="w-6 h-6 text-white" /></div><div><h1 className={`text-2xl sm:text-3xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Calibrated Dynamic Flow</h1><p className={`text-sm sm:text-base ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>+1/sec on path • No penalties • 2 phases • 60s challenge</p></div></div>
        ...
        <section className="sr-only"><h2>Calibrated Dynamic Flow - Fine Motor Path Tracking</h2><p>Fine motor precision drill. Track a scrolling wave path with your cursor. +1 point per second while on the white path. Two phases: Dynamic (0-30s) with moderate waves, Extreme (30-60s) with amplified amplitude and frequency. No penalties - pure flow state training. Adaptive scroll speed slows when locked on path. Best scores saved locally.</p></section>
