...
export default function GhostLinkClient() {
  ...
  const radius = 25;
  const speed = 5;
  const config = { targets: 4, total: 11 };
  ...
  const calculateBonus = useCallback(() => {
    ...
    const bonus = correctSelections * 5; setCorrectCount(correctSelections); setScore(bonus); setShowResults(true);
  ...
  return (
    <div className={`min-h-screen select-none ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "WebApplication", "name": "Ghost-Link Tracking", "url": "https://skilldrills.online/drills/visual/tracking-accuracy/multiple-targets", "description": "Multi-object tracking and visual working memory training. Memorize 4 green targets among 11 moving balls. Track for 60s, then identify. +5 points per correct ball.", "applicationCategory": "EducationalApplication", "operatingSystem": "Web", "offers": { "@type": "Offer", "price": "0", "priceCurrency": "USD" }, "author": { "@type": "Organization", "name": "Global Drill System" }, "educationalUse": ["Multi-Object Tracking", "Visual Working Memory", "Attention Training", "Cognitive Assessment"], "learningResourceType": "Interactive Exercise", "timeRequired": "PT60S", "interactivityType": "active", "inLanguage": "en-US", "teaches": ["Multiple Object Tracking", "Visual Memory", "Divided Attention", "Target Identification"] }) }} />
