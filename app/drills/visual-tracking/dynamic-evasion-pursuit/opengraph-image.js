...
export const alt = 'Dynamic Evasion Pursuit — free browser Visual Tracking drill on SkillDrills';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            {"Overclock tracking responses against rapid directional changes at constant speed scales."}
          </div>
        </div>
