...
// are guaranteed correct — which the old 512x512 icon was not (see page.js).
//
...
export const alt = '180° Awareness Pro — free browser 180 aim trainer for CS2 and Valorant';
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

const ACCENT = '#10b981'; // emerald — this drill's accent
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            Train snap turns and flank awareness. Spin, acquire, and fire on targets
            spawning behind your field of view.
          </div>
        </div>
