...
export const metadata = {
  title: 'Barrier Sequence Pursuit - Visual Pursuit & Tracking Drill | SkillDrills',
  ...
  keywords: ['barrier sequence pursuit', 'visual tracking drill', 'smooth pursuit eye training', 'saccadic eye movement test', 'visual processing speed', 'foveal tracking', 'esports vision training', 'athletic vision drill'],
  openGraph: {
    title: 'Barrier Sequence Pursuit - Visual Pursuit & Tracking Drill | SkillDrills',
    description: 'Acquire and track targets flashing behind sequential barrier gates at 4 corners. Train visual pursuit tracking and coordinate re-acquisition speeds. No sign-up required.',
    type: 'article',
