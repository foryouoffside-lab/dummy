...
export const metadata = {
  ...
  keywords: [
    "grid memorization",
    "grid memorization training",
    "grid memorization game",
    "grid memorization test",
    "grid memorization online",
    "free grid memorization",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/memory/grid-memorization',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Grid Memorization - Spatial Memory | SkillDrills",
    description: "Train spatial memory with progressive 4x4 to 5x5 grids. 5-second memorization, then tap all lit cells. Instant fail on wrong click. No sign-up.",
    url: 'https://skilldrills.online/drills/memory/grid-memorization',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Grid Memorization - Spatial Memory | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function GridMemorizationPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Grid Memorization?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Grid Memorization drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Grid Memorization drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Grid Memorization?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Grid Memorization drill completely free?</h4>
