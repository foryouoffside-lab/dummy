...
export const alt = 'Entropic Grid — free browser Visual Training drill on SkillDrills';
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

const ACCENT = '#e879f9'; // visual category accent
      ...
      >
        ...
        <div
          style={{
            ...
            height: 620,
            borderRadius: 9999,
            background: 'radial-gradient(circle, rgba(232,121,249,0.22) 0%, rgba(5,5,8,0) 70%)',
            display: 'flex',
          }}
        />
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            {"Find the 2-char target in a 10x10 grid. Cells randomly corrupt every 800ms. Stamina system with 90s challenge."}
          </div>
        </div>

        {/* Stat strip */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          {['45S DRILL', 'ADVANCED', 'VISUAL TRAINING', 'FREE — NO SIGN-UP'].map((label) => (
            <div
              key={label}
              style={{
                display: 'flex',
