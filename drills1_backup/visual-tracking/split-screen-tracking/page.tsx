...
export const metadata = {
  ...
  description: "Condition divided attention by tracking two targets moving along vertical and horizon... Play free in your browser with no downloads or registration required.",
  keywords: [
    "split screen tracking",
    "split screen tracking training",
    "split screen tracking game",
    "split screen tracking test",
    "split screen tracking online",
    "free split screen tracking",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Split Screen Tracking - Visual Pursuit & Tracking Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function SplitScreenTrackingPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Split Screen Tracking?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Split Screen Tracking drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Split Screen Tracking drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Split Screen Tracking?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Split Screen Tracking drill completely free?</h4>
