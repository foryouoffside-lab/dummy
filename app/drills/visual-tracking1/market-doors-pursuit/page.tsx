...
export const metadata = {
  title: 'Market Doors Pursuit - Visual Pursuit & Tracking Drill | SkillDrills',
  ...
  keywords: ['market doors pursuit', 'visual tracking drill', 'smooth pursuit eye training', 'saccadic eye movement test', 'visual processing speed', 'foveal tracking', 'esports vision training', 'athletic vision drill'],
  openGraph: {
    title: 'Market Doors Pursuit - Visual Pursuit & Tracking Drill | SkillDrills',
    description: 'Train horizontal saccadic sweeps as targets flash behind 5 centered doors. Train visual pursuit tracking and coordinate re-acquisition speeds. No sign-up required.',
    type: 'article',
