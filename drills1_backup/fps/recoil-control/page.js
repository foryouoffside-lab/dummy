...
export const metadata = {
  ...
  description: "Free recoil control training online. Play free in your browser with no downloads or registration required.",
  keywords: [
    "recoil control",
    "recoil control training",
    "recoil control game",
    "recoil control test",
    "recoil control online",
    "free recoil control",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Recoil Control Training - Free CS2 & Valorant Spray Pattern Drill | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function RecoilControlPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Recoil Control drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Recoil Control?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Recoil Control drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Recoil Control drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Recoil Control?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Recoil Control drill completely free?</h4>
