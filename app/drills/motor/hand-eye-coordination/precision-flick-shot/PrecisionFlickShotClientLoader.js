...
export default dynamic(() => import('./PrecisionFlickShotClient'), {
  loading: () => (
    <div className="w-full rounded-2xl aspect-video min-h-[460px] md:min-h-[500px] bg-[#080811] border border-white/10 flex flex-col items-center justify-center gap-3">
      ...
      <span className="text-xs font-bold uppercase tracking-widest text-slate-400">Loading Precision Flick Shot...</span>
    </div>
  ),
});
