...
export const metadata = {
  title: "Vertical Aim Trainer - Free Vertical Tracking Practice | SkillDrills",
  ...
  keywords: [
    "vertical air track",
    "vertical air track training",
    "vertical air track game",
    "vertical air track test",
    "vertical air track online",
    "free vertical air track",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Vertical Aim Trainer - Free Vertical Tracking Practice | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function VerticalAirTrackPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Vertical Air Track drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Vertical Air Track?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Vertical Air Track drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Vertical Air Track drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Vertical Air Track?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Vertical Air Track drill completely free?</h4>
