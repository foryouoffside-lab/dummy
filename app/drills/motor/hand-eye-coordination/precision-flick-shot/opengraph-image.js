...
export const alt = 'Precision Flick Shot Trainer — free browser flick aim and target acquisition trainer';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            Master mouse flick accuracy, target acquisition speed, and center-click bulls-eye precision.
          </div>
        </div>
