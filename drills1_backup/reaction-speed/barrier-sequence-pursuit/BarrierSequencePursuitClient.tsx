  ...
  useEffect(() => {
    ...
    const drawLoop = (ts: number) => {
      ...
      if (barriers.length === 4) {
        ...
        // Draw Active Target (only if peeking)
        if (trackingState.current.peek > 0) {
          ...
          ctx.beginPath();
          ctx.arc(active[0], active[1], radius, 0, Math.PI * 2);
          ctx.fill();
          
          // Render white core center
          ctx.fillStyle = '#ffffff';
          ctx.beginPath();
          ctx.arc(active[0], active[1], radius * 0.25, 0, Math.PI * 2);
          ctx.fill();
          ctx.restore();
              ...
              <div className="bg-[#0b0f19] border-t border-gray-800 p-8">
                <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-gray-200 tracking-tight">How often should I practice Barrier Sequence Pursuit?</h4>
