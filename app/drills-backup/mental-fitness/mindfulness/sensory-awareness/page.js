...
export default function SensoryScanPage() {
  ...
  const runStep = (pool, index) => {
    ...
    if (comboRef.current > 0 && comboRef.current % 5 === 0) {
      playSound('combo');
      showFeedback(`🔥 ${comboRef.current} Scan Combo! +${comboBonus}`, 'success');
    }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}><span className="font-semibold text-emerald-500">👁️ Visual awareness</span> - Scan for text, colors, light reflections, distances</p>
                    </div>
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}><span className="font-semibold text-blue-500">👂 Auditory attention</span> - Listen for breathing, electronics, quietest sounds</p>
                    </div>
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}><span className="font-semibold text-purple-500">🖐️ Tactile sensation</span> - Feel textures, temperature, weight, relaxation</p>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}><span className="font-semibold text-cyan-500">🧠 Spatial awareness</span> - Expand awareness to environment, estimate distances</p>
                    </div>
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>⭐ Earn <span className="font-semibold text-yellow-500">10 points per scan</span> + combo bonuses every 5 scans</p>
                    </div>
                    <div className="flex items-start gap-2">
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>🎯 The <span className="font-semibold text-pink-500">pulsing circle scales</span> to guide your attention focus</p>
                    </div>
                  </div>
                </div>
                <div className={`mt-3 pt-3 border-t text-xs ${isDarkMode ? 'border-gray-700 text-gray-400' : 'border-gray-200 text-gray-500'} flex items-center justify-between`}>
                  <span>🧘 Builds comprehensive sensory awareness across all modalities</span>
                  <span>🔄 Tasks shuffle randomly for adaptive training</span>
                </div>
              </div>
            </div>
          </div>
