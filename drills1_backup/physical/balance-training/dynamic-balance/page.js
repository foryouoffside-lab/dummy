...
export const metadata = {
  ...
  description: "Free hand eye coordination drill. Play free in your browser with no downloads or registration required.",
  keywords: [
    "dynamic balance",
    "dynamic balance training",
    "dynamic balance game",
    "dynamic balance test",
    "dynamic balance online",
    "free dynamic balance",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/physical/dynamic-balance',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Hand Eye Coordination Drill - Dynamic Balance Training | SkillDrills",
    description: "Free hand eye coordination drill. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/physical/dynamic-balance',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Hand Eye Coordination Drill - Dynamic Balance Training | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function DynamicBalancePage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Dynamic Balance drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Dynamic Balance?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Dynamic Balance drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Dynamic Balance drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Dynamic Balance?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Dynamic Balance drill completely free?</h4>
