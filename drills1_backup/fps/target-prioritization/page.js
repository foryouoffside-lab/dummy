...
export const metadata = {
  title: "Cognitive Aim Trainer - Free FPS Target Selection Practice | SkillDrills",
  ...
  keywords: [
    ...
    "target prioritization training",
    "target prioritization game",
    "target prioritization test",
    "target prioritization online",
    "free target prioritization",
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Cognitive Aim Trainer - Free FPS Target Selection Practice | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function TargetPrioritizationPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Target Prioritization drill?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Target Prioritization?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Target Prioritization drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Target Prioritization drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Target Prioritization?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Target Prioritization drill completely free?</h4>
