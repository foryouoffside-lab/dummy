              ...
              <div className="p-8">
                ...
                <div className="p-5 rounded-xl border bg-black/40 border-gray-800">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FAQItem q="What is peripheral vision training?" a="Peripheral vision training involves exercises designed to expand your active field of view, allowing your brain to process and react to visual stimuli occurring outside of your direct central focus." />
                    <FAQItem q="How does the Peripheral Threat Sweeper work?" a="You must keep your gaze anchored to a central core while identifying and intercepting threat nodes that spawn at the screen's edges and move inward, bridging the gap between visual detection and motor execution." />
                    <FAQItem q="Why is peripheral awareness important for gamers?" a="In esports titles like Valorant, CS2, and Apex Legends, players must keep their crosshair focused centrally while simultaneously monitoring the minimap, ammo, and flanking enemies. Strong peripheral vision reduces tunnel vision and reaction delay." />
                    <FAQItem q="What are the different threat types?" a="As the game difficulty adapts, you will face Standard threats (linear path), Fast threats (Orange, moving 1.5x speed), and Evasive threats (Purple, wobbling and altering their trajectory)." />
                    <FAQItem q="Why do I lose time for clicking empty space?" a="To prevent 'spam clicking'. The drill trains precise visual-motor integration. If you fire without acquiring a valid target, the engine deducts 1.5 seconds from your survival clock to enforce accuracy." />
                    <FAQItem q="What happens during a core breach?" a="If a threat hits the central shield, it violently drains -3.5s from your master survival clock and immediately resets your combo multiplier back to 1.0x." />
                    <FAQItem q="How does the Combo System work?" a="Consecutive intercepts without a core breach or false click build your multiplier. Reach a 40+ streak to unlock the maximum 3.0x score multiplier and rapidly scale the levels." />
                    <FAQItem q="Does the difficulty scale automatically?" a="Yes. Every 150 points you score triggers a Level Up. The engine will accelerate target speeds, decrease the spawn intervals, and introduce harder threat variations." />
                    <FAQItem q="How should I position my eyes for this drill?" a="You should stare directly at the Cyan shield in the center. Let your peripheral vision detect the red flashes on the edges, then reflexively move your mouse to that location without moving your eyes." />
                    <FAQItem q="Is this reflex game free to play?" a="Yes! The SkillDrills Peripheral Sweeper is entirely free, open-source, and runs purely in your web browser with zero downloads required." />
                    <FAQItem q="What is a good score for the Peripheral Threat Sweeper?" a="A score of 1000+ is Platinum tier. 2000+ indicates Diamond-level peripheral acquisition, and 3500+ with 90% accuracy places you in the Elite Master tier." />
                    <FAQItem q="How long should I practice peripheral vision daily?" a="For optimal cognitive adaptation and motor learning, practicing this drill for 5 to 10 minutes a day is far more effective than occasional hour-long sessions." />
                    <FAQItem q="Does this train hand-eye coordination?" a="Yes. You must physically move your mouse to intercept the exact trajectory of the incoming radial target after visually confirming its spawn location." />
                    <FAQItem q="Can beginners use this tactical awareness game?" a="Yes. The game begins at Level 1 with large, slow-moving radial targets, giving beginners time to learn the physics before the engine accelerates." />
                    <FAQItem q="Does this work on mobile devices?" a="This specific drill requires raw mouse input for optimal clicking precision and rapid flicking, making it a desktop-exclusive experience on SkillDrills." />
                  </div>
                </div>
              </div>
            </div>
