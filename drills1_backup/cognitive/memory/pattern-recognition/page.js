...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/cognitive/pattern-recognition',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Pattern Recognition - Sequences | SkillDrills",
    description: "Train pattern recognition with 5 types: Arithmetic, Geometric, Squares, Fibonacci, and Alternating. 5000+ unique sequences. No sign-up.",
    url: 'https://skilldrills.online/drills/cognitive/pattern-recognition',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Pattern Recognition - Sequences | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function PatternRecognitionPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Pattern Recognition?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Pattern Recognition drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Pattern Recognition drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Pattern Recognition?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Pattern Recognition drill completely free?</h4>
