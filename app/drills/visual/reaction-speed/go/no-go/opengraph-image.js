...
export const alt = 'Chroma-Sync Lab — free browser Visual Training drill on SkillDrills';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            {"Click GREEN balls only. Avoid RED balls. Train impulse control and selective response."}
          </div>
        </div>

        {/* Stat strip */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          {['45S DRILL', 'INTERMEDIATE', 'VISUAL TRAINING', 'FREE — NO SIGN-UP'].map((label) => (
            <div
              key={label}
              style={{
                display: 'flex',
