...
export const metadata = {
  ...
  description: "Process RED, BLUE, GREEN batches in 2-second windows. Play free in your browser with no downloads or registration required.",
  keywords: [
    "batch processing",
    "batch processing training",
    "batch processing game",
  ...
  alternates: {
    canonical: 'https://skilldrills.online/drills/cognitive/batch-processing',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Batch Processing - Work Efficiency | SkillDrills",
    description: "Process RED, BLUE, GREEN batches in 2-second windows. Play free in your browser with no downloads or registration required.",
    url: 'https://skilldrills.online/drills/cognitive/batch-processing',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: "Batch Processing - Work Efficiency | SkillDrills",
      },
    ],
  },
  twitter: {
...
export default function BatchProcessingPage() {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the scoring system work in Batch Processing?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Is the Batch Processing drill completely free?",
      "acceptedAnswer": {
        "@type": "Answer",
      ...
      <section className="max-w-4xl mx-auto px-4 py-12 mt-8 border-t border-slate-900" aria-label="Frequently Asked Questions">
        <div className="p-5 rounded-xl border border-gray-800 bg-black/40">
          ...
          <div className="space-y-5">
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">What is the Batch Processing drill?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">How does the scoring system work in Batch Processing?</h4>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-200 tracking-tight">Is the Batch Processing drill completely free?</h4>
